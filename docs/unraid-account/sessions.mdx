...
- Keep the browser session you want to continue using open while you review sessions.
...
If the table has many sessions, use the page controls to move through the list or change how many sessions appear on each page. Click the refresh button to reload the table.
...
- If **IP address** or **User agent** is unavailable for a session, use the activity timestamps and status to decide whether to revoke it.
