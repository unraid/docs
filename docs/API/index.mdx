...
<Tabs>
  <TabItem value="v72" label={translate({ id: 'api.getStarted.v72', message: 'Unraid OS v7.2+' })} default>
    <GetStartedV72 />
  </TabItem>

  <TabItem value="older" label={translate({ id: 'api.getStarted.pre72', message: 'Pre-7.2 Versions' })}>
    <GetStartedPre72 />
  </TabItem>
</Tabs>
