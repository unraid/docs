...
<Tabs>
  <TabItem value="gui" label={translate({ id: 'api.manageKeys.gui', message: 'Web GUI (Recommended)' })} default>
    <ManageApiKeysGui />
  </TabItem>

  <TabItem value="cli" label={translate({ id: 'api.manageKeys.cli', message: 'CLI Method' })}>
    <ManageApiKeysCli />
  </TabItem>
</Tabs>
