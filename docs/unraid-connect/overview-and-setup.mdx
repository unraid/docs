...
<Tabs>
  <TabItem
    value="banner"
    label={translate({ id: 'connect.customization.banner', message: 'Change banner image' })}
    default>
    <ConnectChangeBanner />
  </TabItem>
  ...
  <TabItem
    value="arrange"
    label={translate({ id: 'connect.customization.arrange', message: 'Rearrange dashboard tiles' })}>
    <ConnectRearrangeDashboard />
  </TabItem>

  <TabItem
    value="theme"
    label={translate({ id: 'connect.customization.theme', message: 'Switch themes' })}>
    <ConnectSwitchThemes />
  </TabItem>
</Tabs>
