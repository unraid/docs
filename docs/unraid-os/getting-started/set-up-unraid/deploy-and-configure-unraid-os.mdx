...
3. Choose your boot option:
   ...
   **Next**.
   ...
   If you have questions about device counts or mirrored boot, see the [Internal Boot FAQ (7.3+)](./internal-boot-faq.mdx), which also includes video walkthroughs. For TPM-based licensing questions, see the [TPM Licensing FAQ](../../troubleshooting/tpm-licensing-faq.mdx).
