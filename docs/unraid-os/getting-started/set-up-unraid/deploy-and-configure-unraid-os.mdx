...
3. Choose your boot option:
   ...
   **Next**.
   ...
   If you have questions about device counts or mirrored boot, see the [Internal Boot FAQ](../../troubleshooting/licensing-faq.mdx#internal-boot). For TPM-based licensing questions, see the [TPM Licensing FAQ](../../troubleshooting/tpm-licensing-faq.mdx).
...
7. Troubleshooting
   - After switching from flash boot to internal boot, if the system continues to boot from flash, manually change the boot order in your BIOS.
   - If you see "prohibited by secure boot policy" on the console, disable **Secure Boot** in your BIOS.
