...
3. Choose your boot option:
   ...
   **Next**.
   ...
   If you have questions about device counts, mirrored boot, or TPM-based licensing, see the [Internal Boot & TPM Q&A](../../troubleshooting/licensing-faq.mdx#internal-boot-tpm).
