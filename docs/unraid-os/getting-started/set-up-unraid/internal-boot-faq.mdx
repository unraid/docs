...
This page contains frequently asked questions about internal boot in Unraid OS. For general licensing questions, see the [Licensing FAQ](/unraid-os/troubleshooting/licensing-faq/). For TPM-based licensing questions, see the [TPM Licensing FAQ](/unraid-os/troubleshooting/tpm-licensing-faq/).

---

<details>
  <summary>Optional video walkthroughs</summary>
...
For TPM-based licensing details, see the [TPM Licensing FAQ](/unraid-os/troubleshooting/tpm-licensing-faq/).
