...
>
  | | Clear | Pre-Clear |
  |----------------|-------------------------------|----------------------------------------------|
  | **Purpose** | Ensures basic compatibility | Tests the drive and prepares it
  for use | | **Speed** | Works quickly | Much slower process | | **Array
  Impact** | Runs in the background | Requires the disk to be out of the array |
