...
3.  Select **Tools → New Config** to reset the array configuration
4.  Select the checkbox that confirms you want to use the tool.
5.  Choose the option to preserve all current assignments.
6.  Click Apply.
7.  Go to the Main screen and Unassign the disk you want to remove.
5.  Go back to **Tools → New Config**
9.  Click done.
10. Start the array, but do not check the "Parity is valid" box.
