...
3. Reset the array configuration using **Tools → New Config**, choosing the option to preserve all current assignments. Then click Apply.
4. Unassign the disk you want to remove.
5. Go back to **Tools → New Config** and click done.
