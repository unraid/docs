...
<!-- markdownlint-disable-next-line MD029 -->
9. If you optionnaly started in %%Maintenance Mode|maintenance-mode%%, you need to manually press **sync button** in the Main tab in order to start Data-Rebuild.
