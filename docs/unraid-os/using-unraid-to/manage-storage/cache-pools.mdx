...
<Tabs>
  <TabItem value="single-device" label={translate({ id: 'cachePools.poolModes.singleDevice', message: 'Single device mode' })} default>
  ...
  <TabItem value="multi-device" label={translate({ id: 'cachePools.poolModes.multiDevice', message: 'Multi-device mode' })}>
...
<Tabs>
  <TabItem value="gui" label={translate({ id: 'cachePools.remove.gui', message: 'Using the WebGUI' })} default>
    <RemoveDiskGui />
  </TabItem>

  <TabItem value="commandline" label={translate({ id: 'cachePools.remove.commandLine', message: 'Using the Command Line (Advanced)' })}>
