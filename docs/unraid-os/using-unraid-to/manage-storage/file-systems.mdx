...
- For transfer drives or external devices, it's recommended to use the **[Unassigned Devices](../customize-your-experience/plugins.mdx#unassigned-devices)** plugin, which supports additional file systems.
:::
