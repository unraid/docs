...
For the complete submission process, including repository requirements, XML examples, supported fields, and starter repository guidance, see [Submitting Community Applications](./community-applications-submissions/submission-overview.mdx).
...
3. Submit your application at [ca.unraid.net/submit](https://ca.unraid.net/submit).
