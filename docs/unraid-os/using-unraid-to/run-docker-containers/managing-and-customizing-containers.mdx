...
<Tabs>
  <TabItem
    value="network-type"
    label={translate({ id: 'docker.manage.networkType', message: 'Network type' })}
    default>
    <DockerNetworkType />
  </TabItem>

  <TabItem
    value="volume-mappings"
    label={translate({ id: 'docker.manage.volumeMappings', message: 'Volume mappings' })}>
    <DockerVolumeMappings />
  </TabItem>

  <TabItem
    value="port-mappings"
    label={translate({ id: 'docker.manage.portMappings', message: 'Port mappings' })}>
    <DockerPortMappings />
  </TabItem>

  <TabItem
    value="environment-variables"
    label={translate({ id: 'docker.manage.environmentVariables', message: 'Environment variables' })}>
...
<Tabs>
  <TabItem
    value="start"
    label={translate({ id: 'docker.manage.commands.start', message: 'Start container' })}
    default>
    <DockerCommandStart />
  </TabItem>
  ...
  <TabItem
    value="stop"
    label={translate({ id: 'docker.manage.commands.stop', message: 'Stop container' })}>
    <DockerCommandStop />
  </TabItem>

  <TabItem
    value="restart"
    label={translate({ id: 'docker.manage.commands.restart', message: 'Restart container' })}>
    <DockerCommandRestart />
  </TabItem>

  <TabItem
    value="status"
    label={translate({ id: 'docker.manage.commands.status', message: 'Check container status' })}>
    <DockerCommandStatus />
  </TabItem>

  <TabItem
    value="logs"
    label={translate({ id: 'docker.manage.commands.logs', message: 'Show container logs' })}>
    <DockerCommandLogs />
  </TabItem>
</Tabs>
