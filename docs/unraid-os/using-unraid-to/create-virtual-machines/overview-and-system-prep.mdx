...
2. **For Windows VMs:**
   - Download the latest stable %%VirtIO|virtio%% Windows drivers ISO from the [official repository](https://github.com/virtio-win/virtio-win-pkg-scripts/blob/master/README.mdx).
