...
The available channels and releases can change over time. If a pre-release is available, review the pre-release disclaimer, changelog, and release notes before continuing.
...
## Reporting pre-release issues

Good pre-release feedback helps turn beta and RC builds into better stable releases. When reporting an issue, include:
...
For current pre-release feedback, see [Unraid OS Pre-release (Bugs & Feedback)](https://product.unraid.net/b/unraid-os-prerelease-bugs-feedback). For stable release discussions and announcements, see the [Unraid announcements forum](https://forums.unraid.net/forum/7-announcements/).
