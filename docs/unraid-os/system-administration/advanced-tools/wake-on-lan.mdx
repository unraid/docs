...
<Tabs>
  <TabItem value="Windows" label={translate({ id: 'wakeOnLan.tabs.windows', message: 'Windows' })}>
    <WakeOnLanWindows />
  </TabItem>

  <TabItem value="macOS" label={translate({ id: 'wakeOnLan.tabs.macos', message: 'macOS' })}>
    <WakeOnLanMacos />
  </TabItem>

  <TabItem value="Linux" label={translate({ id: 'wakeOnLan.tabs.linux', message: 'Linux' })}>
    <WakeOnLanLinux />
  </TabItem>
</Tabs>
