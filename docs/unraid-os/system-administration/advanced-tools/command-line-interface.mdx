...
<Tabs>
  <TabItem value="cpu" label={translate({ id: 'cli.systemInfo.cpu', message: 'CPU info' })}>
    <CliCpuInfo />
  </TabItem>

  <TabItem value="memory" label={translate({ id: 'cli.systemInfo.memory', message: 'Memory info' })}>
    <CliMemoryInfo />
  </TabItem>

  <TabItem value="storage" label={translate({ id: 'cli.systemInfo.storage', message: 'Storage info' })}>
    <CliStorageInfo />
  </TabItem>
</Tabs>
