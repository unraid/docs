...
7. (Optional) Enable **Include Tailscale peers in /etc/hosts** to automatically add Tailscale devices to your server's hostname resolution, making it easier to access other devices on your %%Tailnet|tailnet%%.
...
6. Once approved, devices on your %%Tailnet|tailnet%% can access your Unraid server and/or LAN devices by their usual IP addresses.
