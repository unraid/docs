...
- **If you need to set up your own:**
  - Search [Community Applications](/community-applications/) for an HTTP proxy container and review the template, maintainer, and support details before installing it.
...
Start with these docs for current setup guidance:

- **[WireGuard](wireguard.mdx)** - Built-in WireGuard setup, peer configuration, troubleshooting, and tunneled access guidance.

- **[Tailscale](tailscale.mdx)** - Tailscale plugin setup and exit-node guidance.

For community troubleshooting and provider-specific examples, visit the [Unraid forums](https://forums.unraid.net/).
