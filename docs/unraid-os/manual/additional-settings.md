...
Users can set up a VPN connection using [WireGuard](security/vpn.md#wireguard) for secure connections to/from the internet
...
Plugins offered by 3rd parties can add additional sections to the **Scheduler** settings page of the Unraid GUI. Typically they are related to enhancing/tuning the **Parity Check** or **Mover** functionality although this is not mandated.
