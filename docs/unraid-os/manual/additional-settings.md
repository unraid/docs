...
## ![](/docs/legacy/Dynamix.docker.manager.png "File:dynamix.docker.manager.png") Docker {#filedynamix.docker.manager.png_docker}
...
## ![](/docs/legacy/Ident.png "File:ident.png") Identification {#fileident.png_identification}
...
## ![](/docs/legacy/Network-settings.png "File:network-settings.png") Network Settings {#filenetwork_settings.png_network_settings}
...
## ![](/docs/legacy/Share-settings.png "File:share-settings.png") Global Share Settings {#fileshare_settings.png_global_share_settings}
...
## ![](/docs/legacy/Apcupsd.png "File:apcupsd.png") UPS Settings {#fileapcupsd.png_ups_settings}
...
## ![](/docs/legacy/Dynamix.vm.manager.png "File:dynamix.vm.manager.png") VM Manager {#filedynamix.vm.manager.png_vm_manager}
...
## ![](/docs/legacy/Apple-logo.png "File:apple-logo.png") AFP (Apple File Protocol) {#fileapple_logo.png_afp_apple_file_protocol}
...
## ![](/docs/legacy/Linux-logo.png "File:linux-logo.png") NFS (Network File System) {#filelinux_logo.png_nfs_network_file_system}
...
## ![](/docs/legacy/Windows-logo.png "File:windows-logo.png") SMB (Server Message Block) {#filewindows_logo.png_smb_server_message_block}
...
## ![](/docs/legacy/Ftp-server.png "File:ftp-server.png") FTP (File Transfer Protocol) {#fileftp_server.png_ftp_file_transfer_protocol}
...
## <img src="/docs/legacy/Syslog-server-icon.jpg" width="50px" height="50px"  /> Syslog

Users can set up logging of the syslog to permanent storage

## <img src="/docs/legacy/Wireguard-logo.jpg" width="50px" height="50px" /> WireGuard
...
## ![](/docs/legacy/Display-settings.png "File:display-settings.png") Display Settings {#filedisplay_settings.png_display_settings}
...
## ![](/docs/legacy/Notifications.png "notifications.png") Notifications Settings {#notifications.png_notifications_settings}
