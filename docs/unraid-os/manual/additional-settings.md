...
## ![](../assets/date-time-new.png) Date & Time
...
## ![](../assets/Disk-settings.png) Disk Settings
...
## ![](../assets/Dynamix.docker.manager.png) Docker
...
## ![](../assets/Ident.png) Identification
...
## ![](../assets/Network-settings.png) Network Settings
...
## ![](../assets/Share-settings.png) Global Share Settings
...
## ![](../assets/Apcupsd.png) UPS Settings
...
## ![](../assets/Dynamix.vm.manager.png) VM Manager
...
## ![](../assets/Apple-logo.png) AFP (Apple File Protocol)
...
## ![](../assets/Linux-logo.png) NFS (Network File System)
...
## ![](../assets/Windows-logo.png) SMB (Server Message Block)
...
## ![](../assets/Ftp-server.png) FTP (File Transfer Protocol)
...
## ![](../assets/Wireguard-logo.jpg) WireGuard
...
## ![](../assets/Display-settings.png) Display Settings
...
## <img src="/docs/legacy/Notifications.png" width="50px" height="50px" /> Notifications Settings
...
## <img src="/docs/legacy/Scheduler.png" width="50px" height="50px" /> Scheduler
