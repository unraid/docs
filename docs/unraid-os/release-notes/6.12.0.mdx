...
Note: this is no longer an issue as of Unraid [6.12.6](6.12.6.mdx#bug-fixes-and-improvements).
...
In 6.12.0, the [two-nic docker segmentation method](https://forums.unraid.net/topic/137048-guide-how-to-solve-macvlan-and-ipvlan-issues-with-containers-on-a-custom-network/) is a viable workaround, but our recommendation is to upgrade to Unraid [6.12.4](6.12.4.mdx) which has a better solution.
