...
- Critical: In 7.3.0-beta.1, non-encrypted XFS pools can fail to mount, causing all drives in the pool to appear unmountable. See [7.3.0 beta1 - (non-encrypted) xfs pool all drives are un-mountanble](https://product.unraid.net/p/7-3-0-beta1-non-encrypted-xfs-pool-all-drives-are-un-mountanble).
