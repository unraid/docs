...
The public beta.1 changelog is retained below for broader 7.3 context while the prerelease cycle is still active, including the original dedicated boot device support rollout and the related onboarding and licensing changes.
