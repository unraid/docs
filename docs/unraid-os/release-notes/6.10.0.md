...
automatically selects TPM-aware OVMF bios.  Also, [here are instructions](../using-unraid-to/create-virtual-machines/other-vm-operating-systems.md#upgrading-to-windows-11)
