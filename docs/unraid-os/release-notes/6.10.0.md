...
We removed certain strings from [Diagnostics](../troubleshooting/diagnostics-information.md) such as passwords found in the 'go' file.
...
More information including use cases may be found in Documentation [here](../manual/security/secure-webgui-ssl.md).
...
automatically selects TPM-aware OVMF bios.  Also, [here are instructions](../manual/vm/vm-support.md#upgrading-a-vm-to-windows-11)
...
- Fixed issue in [User Share](../manual/shares/user-shares.md) file system where permissions were not being honored.
