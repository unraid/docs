...
- Fix: emhttpd could crash when stopping the array after a storage device went offline
...
- wsdd2-1.8.7-x86_64-2_SBo_LT.tgz (patched to not exclude shim interfaces)
