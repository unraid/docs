...
Unraid OS 7.3.2 is a stable security and bugfix release with WebGUI security fixes, Linux kernel 6.18.38-Unraid, Docker VLAN networking fixes, storage and boot-pool fixes, virtualization UI fixes, Unraid API 4.35.1, and base distro package updates.
...
* No new release-specific known issues are noted. For issues inherited from prior releases, see the [Unraid OS 7.3.1](<https://docs.unraid.net/unraid-os/release-notes/7.3.1/>) release notes.
...
* No new rollback limitations are noted for this release. Before rolling back, review the [Unraid OS 7.3.1](<https://docs.unraid.net/unraid-os/release-notes/7.3.1/>) release notes.
...
* Improvement: Improved Docker tab load performance by keeping synchronous I/O off the Docker tab render path, based on a community contribution from [Spader](<https://github.com/tspader>) in [unraid/webgui#2641](https://linear.app/lime-technology/review/fixdocker-keep-synchronous-io-off-the-docker-tab-render-path-52c073c02117).
...
* libvirt-php: version 0.5.8-8.4.21_LT -> 0.5.8-8.4.23_LT
...
* php: version 8.4.21-1_LT -> 8.4.23-1_LT (CVE-2026-14355)
* pkgtools: version 15.1-31 -> 15.1-32
* qemu: version 10.2.2-1_SBo_LT -> 10.2.3-1_SBo_LT
* rsync: version 3.4.3 -> 3.4.4
* samba: version 4.22.10-1_LT -> 4.22.10-2_LT (CVE-2026-1933, CVE-2026-2340, CVE-2026-3012, CVE-2026-3238, CVE-2026-4408, CVE-2026-4480)
...
* zfs: version 2.4.2_6.18.33_Unraid-1_LT -> 2.4.3_6.18.38_Unraid-1_LT
