...
If rolling back earlier than 6.12.4, also see the [6.12.4 release notes](6.12.4.mdx#rolling-back).

## Changes vs. [6.12.5](6.12.5.mdx)
...
* The workaround for [crashes related to the i915 driver on Rocket Lake systems](6.12.0.mdx#crashes-related-to-i915-driver) is no longer needed.
