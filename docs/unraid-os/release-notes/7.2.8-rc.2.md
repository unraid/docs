...
This release candidate updates the Linux kernel to 6.12.98-Unraid, with matching storage-module compatibility checks passing versus Unraid OS 7.2.8-rc.1.
...
* No new release-specific known issues are identified in the source context. Refer to the previous relevant release notes.

## Notes

* Kernel-coupled ZFS modules pass compatibility checks for 6.12.98-Unraid.

## Rolling back

* No release-specific rollback blockers are identified in the source context.
* Review the Unraid OS 7.2.8-rc.1 release notes before rolling back.

## Changes vs. Unraid OS 7.2.8-rc.1
