...
- Fix: Cannot change disk format directly from XFS to XFS encrypted or EXT4 to EXT4 encrypted \[-stable]
...
- Fix: Docker NAT failure due to missing br\_netfilter \[-stable]
...
- kbd: version 2.9.0
- kernel-firmware: version 20251018\_8b4de42 \[-stable]
- krb5: version 1.22.1
...
- libedit: version 20251016\_3.1 \[-stable]
