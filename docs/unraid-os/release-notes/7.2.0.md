...
Search this page for `-rc.2` to see what has changed since the last RC.
...
- Fix: Display aberration when creating a VM snapshot \[-rc.2]
...
- Fix: On **_Settings → Display Settings → Font size_**, remove extreme options that break the webGUI \[-rc.2]
- Fix: Display aberration on **_Settings → Scheduler_** when set to Hourly \[-rc.2]
- Fix: Disabled dropdown menu items were not shown in disabled color in Firefox \[-rc.2]
...
- kbd: version 2.9.0
- kernel-firmware: version 20251011_919daee \[-rc.2]
- krb5: version 1.22.1
- less: version 679
