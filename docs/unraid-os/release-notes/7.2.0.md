# Version 7.2.0-beta.2 2025-08-07
...
* Some testers are reporting issues with high CPU load, possibly related to LSOF. Not common, but [details in the forum](https://forums.unraid.net/bug-reports/prereleases/high-cpu-usage-lsof-720-beta1-r4005/)
* If the array does not start in this release, please [see this forum post](https://forums.unraid.net/bug-reports/prereleases/unable-to-start-array-after-upgrading-to-720-beta1-r4009/) for a quick fix. Also not common.
* The File Manager has some visual issues that will be resolved in the next release
...
* kbd: version 2.8.0
* kernel-firmware: version 20250730_910c190
* less: version 679
