# Version 7.0.0-beta.1 2024-06-25
...
supported by OpenZFS as of this date.  We anticipate OpenZFS support for kernels beyond 6.9 is imminent
...
See the warnings under [Known Issues](#known-issues).
...
```bash
mover start -e diskN  # where N is [1..28]
```
...
For more details see the [manual](https://docs.unraid.net/unraid-os/manual/security/outgoing-proxy-manager/).
