...
If your existing BTRFS pools fail to import with *Wrong Pool State, invalid expansion* there is a simple fix, see this [forum post](https://forums.unraid.net/topic/184435-unraid-os-version-700-available/#findComment-1508012).
