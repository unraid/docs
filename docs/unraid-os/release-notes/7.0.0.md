...
Note: if you have the Mover Tuning plugin installed you will see an error when the mover script is being patched. It is safe to ignore, we are working on a way to improve that experience.
