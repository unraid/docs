...
* No new release-specific known issues are identified in this release. Review the [Unraid OS 7.2.7](/unraid-os/release-notes/7.2.7/) release notes for prior known issues.

## Rolling back

* No new rollback warnings are identified in this release. Review the [Unraid OS 7.2.7](/unraid-os/release-notes/7.2.7/) release notes before rolling back.

## Changes vs. [Unraid OS 7.2.7](/unraid-os/release-notes/7.2.7/)

### Security

* Security: This release includes security-related updates across multiple base distro packages.

### Networking / Hardware

* New: Added Intel iwlwifi firmware files.
