...
Unraid OS 7.2.8-rc.2 is a release candidate maintenance release focused on security-related base package updates, Linux kernel 6.12.98-Unraid, Unraid API 4.36.1, Docker, ZFS, and expanded Intel wireless firmware coverage.
...
* Kernel-coupled ZFS modules passed compatibility checks for 6.12.98-Unraid.
