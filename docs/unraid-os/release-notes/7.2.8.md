# Version 7.2.8 2026-07-23

Unraid OS 7.2.8 is a stable maintenance release focused on security-related base package updates, Linux kernel 6.12.96-Unraid, Unraid API 4.36.1, Docker, ZFS, and expanded Intel wireless firmware coverage.

Recommended for users who want the latest security-related base distro updates.
