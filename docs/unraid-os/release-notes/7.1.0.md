# Version 7.1.0-beta.2 2025-03-xx
...
* mover
  ...
  * Fix: mover was not handling hard links properly when @TODO [-beta.2]
...
* Fix: Automatically set regulatory region when joining an access point [-beta.2]
