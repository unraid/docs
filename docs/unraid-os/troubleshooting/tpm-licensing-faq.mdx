---
sidebar_position: 5
sidebar_label: TPM Licensing FAQ
toc_max_heading_level: 3
---

# TPM Licensing FAQ

This page contains frequently asked questions about TPM-based licensing in Unraid OS. For general licensing questions, see the [Licensing FAQ](licensing-faq.mdx). For internal boot questions, see the [Internal Boot FAQ](../getting-started/set-up-unraid/internal-boot-faq.mdx).

---

<a id="tpm"></a>

### How can I move from flash-based licensing to TPM-based licensing?
...
To proactively switch to TPM-based licensing, navigate to **_Tools → Registration_** and click **Move License to TPM**. You are taken to the Unraid Account website, where you can approve the replacement request.
...
### What are the benefits of moving to TPM-based licensing?
...
### What if my motherboard does not have a TPM device?
...
<a id="tpm-flash-boot"></a>

### Can I switch to TPM-based licensing while booting from flash?

Yes, the licensing method is not tied to the boot method.

For internal boot-specific questions, see the [Internal Boot FAQ](../getting-started/set-up-unraid/internal-boot-faq.mdx).

<a id="tpm-vm"></a>

### Can I use TPM from within an Unraid VM?

No, this is not supported.

<a id="tpm-usb-replacement"></a>

### Can I move my license between TPM and USB if I need to recover from hardware failure?
...
### Will a TPM reset affect my Unraid license?
