...
This page contains frequently asked questions about TPM-based licensing in Unraid OS. For general licensing questions, see the [Licensing FAQ](licensing-faq.mdx).
