...
This page contains frequently asked questions about TPM-based licensing in Unraid OS. For general licensing questions, see the [Licensing FAQ](/unraid-os/troubleshooting/licensing-faq/). For internal boot questions, see the [Internal Boot FAQ](/unraid-os/getting-started/set-up-unraid/internal-boot-faq/).
...
For internal boot-specific questions, see the [Internal Boot FAQ](/unraid-os/getting-started/set-up-unraid/internal-boot-faq/).
