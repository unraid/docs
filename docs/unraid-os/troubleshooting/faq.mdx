...
This is feasible but requires additional steps. See [GPU passthrough for virtual machines](../using-unraid-to/create-virtual-machines/vm-setup.mdx#gpu-passthrough-for-virtual-machines) for setup guidance.
