...
<Tabs>
  <TabItem value="mirror" label={translate({ id: 'diagnostics.syslog.mirror', message: 'Mirror to flash' })} default>
    <SyslogMirror />
  </TabItem>

  <TabItem value="remote" label={translate({ id: 'diagnostics.syslog.remote', message: 'Remote syslog server' })}>
    <SyslogRemote />
  </TabItem>

  <TabItem value="local" label={translate({ id: 'diagnostics.syslog.local', message: 'Local syslog server' })}>
    <SyslogLocal />
  </TabItem>
</Tabs>
...
<Tabs>
  <TabItem value="via-webgui" label={translate({ id: 'diagnostics.dockerLogs.webgui', message: 'Via WebGUI' })} default>
    <DockerLogsViaWebGUI />
  </TabItem>

  <TabItem value="commandline" label={translate({ id: 'diagnostics.dockerLogs.commandLine', message: 'Via Command Line' })}>
    <DockerLogsCommandLine />
  </TabItem>

  <TabItem value="persistent" label={translate({ id: 'diagnostics.dockerLogs.persistent', message: 'Persistent logging' })}>
