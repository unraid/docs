...
### How do I redeem a license activation code?

See [Redeem Activation Code](../../unraid-account/redeem-activation-code.mdx)

<a id="oem-purchase"></a>

### I'm a reseller/OEM needing to purchase a license on behalf of my customer. What should I do?
...
### How do I manually install my license keyfile to my boot device?
...
### How can I determine my registration type?
...
### What happens with pre-releases (Beta/RC versions)?
...
### What happens if my boot device fails? Do I have to repurchase a license?
...
### What should I do if I get an error registering my boot device: '####-####-####-#############' is already registered to another user?
...
### Can I transfer my trial key to a new boot device?
