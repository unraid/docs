...
import ManualKeyfileOffline from './partials/licensing-faq/manual-keyfile-offline.mdx';
import ManualKeyfileNetwork from './partials/licensing-faq/manual-keyfile-network.mdx';
...
<details>
  ...
  <Tabs>
    <TabItem value="offline" label={translate({ id: 'licensing.manualKey.offline', message: 'Manual (Offline) method' })}>
      <ManualKeyfileOffline />
    </TabItem>

    <TabItem value="network" label={translate({ id: 'licensing.manualKey.network', message: 'Network (Online) method' })}>
