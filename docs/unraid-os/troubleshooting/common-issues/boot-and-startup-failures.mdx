...
This topic is covered in detail under the [Prepare your USB device](../../getting-started/set-up-unraid/create-your-bootable-media.mdx#prepare-your-usb-device) section.
...
6. Try booting in [Safe Mode](../../using-unraid-to/customize-your-experience/plugins.mdx#troubleshooting-with-safe-mode) to check for any plugin-related problems.
