...
const config: Config = {
  ...
  plugins: [
    ...
    { from: "/go/expanding-windows-vmvdisk-partitions/", to: "/unraid-os/using-unraid-to/create-virtual-machines/windows-on-a-vm/#expanding-windows-vm-vdisk-partitions" },
