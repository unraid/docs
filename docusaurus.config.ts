...
const config: Config = {
  ...
  plugins: [
    ...
    { from: "/unraid-os/faq/redeem-license-activation-code/", to: "/unraid-os/troubleshooting/licensing-faq/#redeem-activation-code" },
    ...
    { from: "/unraid-os/getting-started/advanced-bios-config/", to: "/unraid-os/getting-started/set-up-unraid/deploy-and-configure-unraid-os/#bios-recommendations" },
    ...
    { from: "/unraid-os/manual/getting-started/advanced-bios-config/", to: "/unraid-os/getting-started/set-up-unraid/deploy-and-configure-unraid-os/#bios-recommendations" },
    ...
    { from: "/unraid-os/manual/storage-management/", to: "/unraid-os/using-unraid-to/manage-storage/array-configuration/" },
    ...
    { from: "/contribute-to-docs/how-to-contribute/", to: "/category/contribute/" },
    { from: "/contribute-to-docs/intro/", to: "/category/contribute/" },
    { from: "/contribute-to-docs/unraid-styleguide/", to: "/category/contribute/" },
    { from: "/contribute-to-docs/unraid-styleguide/golden-rules/", to: "/category/contribute/" },
    { from: "/contribute-to-docs/unraid-styleguide/conventions/", to: "/category/contribute/" },
    ...
    { from: "/go/advanced-bios-config/", to: "/unraid-os/getting-started/set-up-unraid/deploy-and-configure-unraid-os/#bios-recommendations" },
    { from: "/go/applications/", to: "/unraid-os/using-unraid-to/run-docker-containers/community-applications/" },
    { from: "/go/backing-up-your-flash-drive/", to: "/unraid-os/system-administration/maintain-and-update/changing-the-flash-device/#backing-up-your-flash-device" },
    ...
    { from: "/go/configuring-vpn-tunneled-access-for-system/", to: "/unraid-os/system-administration/secure-your-server/wireguard/#configuring-vpn-tunneled-access-for-system" },
    { from: "/go/connect-about/", to: "/unraid-connect/overview-and-setup/" },
    { from: "/go/connect-customizable-dashboard/", to: "/unraid-connect/overview-and-setup/#customization" },
    ...
    { from: "/go/connect-dynamic-remote-access/", to: "/unraid-connect/remote-access/#dynamic-remote-access-setup" },
    ...
    { from: "/go/connect-license-management/", to: "/unraid-connect/overview-and-setup/#license-management" },
    { from: "/go/connect-manage-server-from-connect/", to: "/unraid-connect/overview-and-setup/#manage-your-server-from-within-the-connect-ui" },
    { from: "/go/connect-privacy/", to: "/unraid-connect/automated-flash-backup/#privacy-and-security" },
    { from: "/go/connect-remote-access/", to: "/unraid-connect/remote-access/" },
    { from: "/go/connect/", to: "/unraid-connect/overview-and-setup/" },
    { from: "/go/determining-hvmiommu-hardware-support/", to: "/unraid-os/using-unraid-to/create-virtual-machines/overview-and-system-prep/#hvm--iommu-what-they-enable" },
    { from: "/go/data-encryption/", to: "/unraid-os/system-administration/secure-your-server/securing-your-data/" },
    ...
    { from: "/go/expanding-windows-vm-vdisk-partitions/", to: "/unraid-os/using-unraid-to/create-virtual-machines/windows-on-a-vm/#expanding-windows-vm-vdisk-partitions" },
    { from: "/go/faq-licensing-pre-release/", to: "/unraid-os/troubleshooting/licensing-faq/#pre-release-policy" },
    { from: "/go/faq-licensing-redeem-activation-code/", to: "/unraid-os/troubleshooting/licensing-faq/#redeem-activation-code" },
    ...
    { from: "/go/managing-api-keys/", to: "/API/how-to-use-the-api/#managing-api-keys" },
    ...
    { from: "/go/microsoft-windows-as-a-vm/", to: "/unraid-os/using-unraid-to/create-virtual-machines/windows-on-a-vm/" },
    { from: "/go/multi-language/", to: "/unraid-os/using-unraid-to/customize-your-experience/multi-language-support/" },
    { from: "/go/multiple-pools/", to: "/unraid-os/using-unraid-to/manage-storage/cache-pools/" },
    ...
    { from: "/go/quick-install-guide-assigning-devices/", to: "/unraid-os/getting-started/set-up-unraid/configure-your-array/#assign-parity-and-data-disks" },
    { from: "/go/quick-install-guide-connecting-to-webgui/", to: "/unraid-os/getting-started/set-up-unraid/deploy-and-configure-unraid-os/#connect-to-the-unraid-webgui" },
    ...
    { from: "/go/quick-install-guide-setting-up/", to: "/unraid-os/getting-started/set-up-unraid/deploy-and-configure-unraid-os/" },
    ...
    { from: "/go/upgrading-a-vm-to-windows-11/", to: "/unraid-os/using-unraid-to/create-virtual-machines/windows-on-a-vm/#upgrading-to-windows-11" },
    { from: "/go/user-shares/", to: "/unraid-os/using-unraid-to/manage-storage/shares/" },
    { from: "/go/vm-adjust-bios-settings/", to: "/unraid-os/using-unraid-to/create-virtual-machines/overview-and-system-prep/#adjust-bios-settings" },
    { from: "/go/vm-expanding-a-vdisk/", to: "/unraid-os/using-unraid-to/create-virtual-machines/vm-setup/#expand-a-vdisk" },
    ...
    { from: "/go/ups-settings/", to: "/unraid-os/getting-started/set-up-unraid/customize-unraid-settings/#ups-settings" },
    { from: "/go/webgui-ssl/", to: "/unraid-os/system-administration/secure-your-server/securing-your-connection/" },
    { from: "/go/what-kind-of-usb-device-do-i-need/", to: "/unraid-os/system-administration/maintain-and-update/changing-the-flash-device/#selecting-a-replacement-device" },
        ],
      },
    ],
  ],
