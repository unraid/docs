...
Sie können jetzt Ihre Single-VDEV RAIDZ1/2/3-Pools um jeweils ein Laufwerk erweitern. Ausführliche Anweisungen finden Sie unter [Erweiterung von RAIDZ](../../using-unraid-to/manage-storage/cache-pools.mdx#raidz-erweiterung).
