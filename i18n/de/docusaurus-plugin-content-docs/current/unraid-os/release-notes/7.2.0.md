...
- Fix: Fehler im Zusammenhang mit _searchLink_ beim Installieren von Plugins verhindern.
- Fix: PHP-Warnungen beim Importieren von WireGuard-Tunneln.
- Verbesserung: Zeitzone _Europe/Kiev_ in _Europe/Kyiv_ umbenannt, um sich an die IANA Time Zone Database anzugleichen.
