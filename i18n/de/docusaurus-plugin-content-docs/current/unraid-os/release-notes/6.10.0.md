...
Weitere Informationen, einschließlich Anwendungsfällen, finden Sie in der Dokumentation [hier](/de/unraid-os/system-administration/secure-your-server/securing-your-connection).

Weitere Informationen, einschließlich Anwendungsbeispielen, finden Sie in der Dokumentation [hier](/de/unraid-os/system-administration/secure-your-server/securing-your-connection).
...
- md/unriad: Version 2.9.22
  - Behebung: md\_sync\_limit wurde ignoriert
...
- emhttp neue Vorgaben:
  ...
  - Anpassung des Standardwerts für poll\_attributes von 30 Min. auf 30 Sek.
...
- rc.nginx: Entfernen des Standardserverblocks, der 404 für HTTPS zurückgibt, wenn USE\_SSL==no und kein CA-signiertes Zertifikat vorhanden ist
...
- shfs: Behebung des Fehlers, bei dem die Berechtigungen ignoriert wurden ('default\_permissions' fehlte im mount-Befehl)
- sysctl: Behandlung der Überschreitung von net.netfilter.nf\_conntrack\_count max (Einstellung auf 131072 erhöht)
...
- WebGUI: Device\_list ersetzt .png-Icon durch Schriftzeichen.
