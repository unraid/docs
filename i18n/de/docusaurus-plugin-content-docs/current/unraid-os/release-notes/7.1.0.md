...
Von _**Einstellungen → CPU-Einstellungen**_ oder beim Bearbeiten einer VM, drücken Sie **Alles Abwählen**, um alle Kerne für diese VM zu lösen, und setzen Sie die Anzahl der vCPUs auf 1, erhöhen Sie bei Bedarf.
