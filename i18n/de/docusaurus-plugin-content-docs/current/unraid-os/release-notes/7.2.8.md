...
Unraid OS 7.2.8 ist ein stabiles Update mit Schwerpunkt auf Sicherheitsbehebungen, einem Linux-Kernel-Update auf 6.12.98-Unraid, Unraid-API-Updates, Firmware-Ergänzungen und umfassenden Paketaktualisierungen der Basisdistribution.

Wir empfehlen das Upgrade von Unraid OS 7.2.7, um die enthaltenen Sicherheitskorrekturen zu erhalten.
...
- Es sind keine neuen release-spezifischen bekannten Probleme dokumentiert. Lesen Sie die Release Notes von Unraid OS 7.2.7 für bekannte Probleme, die möglicherweise weiterhin zutreffen.

## Anmerkungen

- Diese Version enthält hinzugefügte Intel-iwlwifi-Firmwaredateien.

## Rückschritte

- Es sind keine neuen release-spezifischen Rollback-Warnungen dokumentiert. Prüfen Sie vor einem Rollback die Rollback-Hinweise von Unraid OS 7.2.7.
...
- Sicherheit: Behebt Sicherheitsprobleme in Komponenten, die Unraid OS 7.2.7 betrafen, darunter bind, curl, dnsmasq, iperf3, libXfont2, libevent, libgpg-error, libidn, libseccomp, libssh, nginx, OpenSSH, OpenSSL, p11-kit, rsync, Samba, shadow, sqlite und xorg-server.
...
- Unraid-API auf [dynamix.unraid.net](\<https://dynamix.unraid.net>) 4.36.1 aktualisieren – siehe [Änderungen](\<https://github.com/unraid/api/releases>).

### Linux-Kernel

- Auf 6.12.98-Unraid aktualisieren
