...
### Mover verwenden, um ein Array-Disk zu leeren {/* #using-mover-to-empty-an-array-disk */}

:::warning[Removed in Unraid 7.2.1]

Diese Befehlszeilenoption wurde in Unraid 7.2.1 entfernt. In neueren Versionen verwenden Sie stattdessen die WebGUI-Methode. Siehe [Konvertieren zu einem neuen Dateisystemtyp](../using-unraid-to/manage-storage/file-systems.mdx#converting-to-a-new-file-system-type) für Details.
...
### Unterstützung zur Einbettung des WebGUI in Frame {/* #tailscale-integration */}
