# Version 7.2.8-rc.2 2026-07-28

Dieses Release Candidate aktualisiert den Linux-Kernel auf 6.12.98-Unraid, wobei die passenden Kompatibilitätsprüfungen der Speicher-Module gegenüber Unraid OS 7.2.8-rc.1 bestanden wurden.

## Upgrade

Schritt-für-Schritt-Anweisungen finden Sie unter Unraid aktualisieren. Fragen zu Ihrer Lizenz?

## Bekannte Probleme

- Es wurden im Quellkontext keine neuen release-spezifischen bekannten Probleme identifiziert. Verweisen Sie auf die vorherigen relevanten Release Notes.

## Anmerkungen

- Kernelgekoppelte ZFS-Module bestehen die Kompatibilitätsprüfungen für 6.12.98-Unraid.

## Rückschritte

- Im Quellkontext sind keine release-spezifischen Rücksetzungsblocker identifiziert.
- Überprüfen Sie vor dem Zurückrollen die Versionshinweise zu Unraid OS 7.2.8-rc.1.

## Änderungen gegenüber Unraid OS 7.2.8-rc.1

### Linux-Kernel

- Linux-Kernel: Aktualisierung auf 6.12.98-Unraid.
