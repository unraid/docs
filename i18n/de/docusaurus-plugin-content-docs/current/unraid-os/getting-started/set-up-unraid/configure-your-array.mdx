...
:::important
Ihr %%array|array%% wird nicht starten, wenn Sie die Anzahl der durch Ihren Lizenzschlüssel erlaubten Speichergeräte überschreiten.
:::

## Starten und Formatieren des Arrays

Nachdem Sie alle Ihre Geräte zugewiesen haben, klicken Sie unter **Array-Betrieb** auf die Schaltfläche **Start**, um sie zu mounten und das %%array|array%% zu starten.
...
Ein Paritätssync wird im Hintergrund ausgeführt, um das %%array|array%% selbst vor Abschluss der Formatierung zu schützen. Das %%array|array%% wird in einem ungeschützten Zustand funktionieren, bis der Sync abgeschlossen ist. Es ist daher am besten, mit dem Hinzufügen von Daten zu warten.
