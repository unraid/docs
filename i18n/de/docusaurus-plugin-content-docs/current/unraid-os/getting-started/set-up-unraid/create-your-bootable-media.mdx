...
Unter Windows können Laufwerke, die größer als 32 GB sind, mit den integrierten Formatierungswerkzeugen nicht als FAT32 formatiert werden (sie verwenden standardmäßig exFAT). Für größere Laufwerke müssen Sie ein Drittanbieter-Tool wie [Rufus](https://rufus.ie/en/) verwenden, um sie als FAT32 zu formatieren.
