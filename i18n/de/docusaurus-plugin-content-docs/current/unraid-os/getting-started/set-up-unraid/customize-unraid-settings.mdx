...
- <img
    src="/img/customize-unraid-settings/icons/icon-bark.png"
    alt="Bark"
    style={{ height: "20px", verticalAlign: "middle", marginRight: "8px" }}
  />
  **Bark**: iOS-Benachrichtigungs-App
- <img
    src="/img/customize-unraid-settings/icons/icon-boxcar.png"
    alt="Boxcar"
    style={{ height: "20px", verticalAlign: "middle", marginRight: "8px" }}
  />
  **Boxcar**: Push-Nachrichtendienst
- <img
    src="/img/customize-unraid-settings/icons/icon-discord.png"
    alt="Discord"
    style={{ height: "20px", verticalAlign: "middle", marginRight: "8px" }}
  />
  **Discord**: Senden von Benachrichtigungen an Discord-Kanäle über Webhook
- <img
    src="/img/customize-unraid-settings/icons/icon-gotify.png"
    alt="Gotify"
    style={{ height: "20px", verticalAlign: "middle", marginRight: "8px" }}
  />
  **Gotify**: Selbstgehosteter Benachrichtigungsserver
- <img
    src="/img/customize-unraid-settings/icons/icon-ntfy.png"
    alt="ntfy.sh"
    style={{ height: "20px", verticalAlign: "middle", marginRight: "8px" }}
  />
  **ntfy.sh**: Einfacher HTTP-basierter Benachrichtigungsdienst
- <img
    src="/img/customize-unraid-settings/icons/icon-prowl.png"
    alt="Prowl"
    style={{ height: "20px", verticalAlign: "middle", marginRight: "8px" }}
  />
  **Prowl**: iOS-Push-Benachrichtigungen
- <img
    src="/img/customize-unraid-settings/icons/icon-pushbits.png"
    alt="Pushbits"
    style={{ height: "20px", verticalAlign: "middle", marginRight: "8px" }}
  />
  **Pushbits**: Selbstgehostete Benachrichtigungsweiterleitung
- <img
    src="/img/customize-unraid-settings/icons/icon-pushbullet.png"
    alt="Pushbullet"
    style={{ height: "20px", verticalAlign: "middle", marginRight: "8px" }}
  />
  **Pushbullet**: Plattformübergreifender Benachrichtigungsdienst
- <img
    src="/img/customize-unraid-settings/icons/icon-pushover.png"
    alt="Pushover"
    style={{ height: "20px", verticalAlign: "middle", marginRight: "8px" }}
  />
  **Pushover**: Push-Benachrichtigungsdienst für iOS und Android
- <img
    src="/img/customize-unraid-settings/icons/icon-pushplus.png"
    alt="Pushplus"
    style={{ height: "20px", verticalAlign: "middle", marginRight: "8px" }}
  />
  **Pushplus**: Chinesischer Push-Nachrichtendienst
- <img
    src="/img/customize-unraid-settings/icons/icon-serverchan.png"
    alt="ServerChan"
    style={{ height: "20px", verticalAlign: "middle", marginRight: "8px" }}
  />
  **ServerChan**: Chinesischer Serverüberwachungs- und Benachrichtigungsdienst
- <img
    src="/img/customize-unraid-settings/icons/icon-slack.png"
    alt="Slack"
    style={{ height: "20px", verticalAlign: "middle", marginRight: "8px" }}
  />
  **Slack**: Senden von Benachrichtigungen an Slack-Kanäle über Webhook
- <img
    src="/img/customize-unraid-settings/icons/icon-telegram.png"
    alt="Telegram"
    style={{ height: "20px", verticalAlign: "middle", marginRight: "8px" }}
  />
