...
Informationen zur Entscheidung zwischen Stable-, Beta- und Release Candidate-(RC)-Builds finden Sie unter [Unraid OS release types](./release-types.mdx).

:::note\[Prerequisites]

Bevor Sie mit der Aktualisierung beginnen, erstellen Sie unbedingt ein vollständiges Backup Ihres Startlaufwerks. Weitere Einzelheiten finden Sie unter [Sichern Ihres Startlaufwerks](../system-administration/maintain-and-update/changing-the-flash-device.mdx#backing-up-your-flash-device).

:::

:::tip[Best Vorgehensweisen vor dem Aktualisieren]
