...
## Unterstützte Minor-Serien und EOL

Unraid unterstützt jeweils zwei öffentliche Minor-Serien gleichzeitig:

- Die **aktuelle öffentliche Minor-Serie**, z. B. `7.3.x`, sobald eine Beta-, RC- oder stabile Veröffentlichung von `7.3` öffentlich verfügbar ist.
- Die **vorherige öffentliche Minor-Serie**, z. B. `7.2.x`, während `7.3.x` die aktuelle öffentliche Serie ist.

Eine öffentliche Beta- oder RC-Version zählt für Supportrichtlinien-Zwecke als öffentliche Minor-Serie. Das bedeutet nicht, dass Beta- oder RC-Veröffentlichungen für den Produktiveinsatz empfohlen werden; es bedeutet nur, dass sich das Supportfenster nach vorne verschiebt, wenn die nächste Minor-Serie öffentlich wird.

Verwenden Sie innerhalb einer unterstützten Minor-Serie die neueste verfügbare Patch- oder Pre-Release-Build-Version dieser Serie. Ältere Patch-Builds derselben Serie werden ersetzt und bleiben nur für Archivierung, Rollback und als Referenz in den Versionshinweisen verfügbar.

Ältere Minor-Serien sind **End of Life (EOL)**. EOL-Veröffentlichungen werden nicht unterstützt und enthalten keine Fehlerbehebungen oder Sicherheitsupdates mehr.

Um den aktuellen Status einer Veröffentlichung zu prüfen, siehe das [Versionsarchiv](../download_list.mdx).
...
- Öffentliche Beta- und RC-Versionen werden bei der Ermittlung der aktuellen öffentlichen Minor-Serie mitgezählt.
