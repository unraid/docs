...
Nicht alle Hardware unterstützt den S3-Schlaf oder WoL zuverlässig. Einige Systeme können Probleme beim Eintritt in den Schlaf oder beim korrekten Aufwachen haben oder zusätzliche BIOS/%%UEFI|uefi%%-Einstellungen erfordern. Testen Sie diese Funktionen immer gründlich, bevor Sie sich darauf verlassen.
:::
