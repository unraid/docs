...
Installieren Sie DiskSpeed über [Community-Anwendungen](/community-applications/) (***Apps-Tab***) durch die Suche nach "DiskSpeed" oder besuchen Sie das [GitHub-Repository](https://github.com/jbartlett777/DiskSpeed) für manuelle Installationsanweisungen.
...
:::tip[Understand die Ausgabe]

Ein niedriger "verfügbar"-Speicherwert deutet nicht unbedingt auf ein Problem hin—Linux cached Daten aggressiv für die Performance.
...
## Fdisk-Nutzung anzeigen {/* #file-transfer-operations */}
