...
>
![Steuerelement „Backup des Boot-Geräts“ in der WebGUI](/img/flashbackup.png)
</div>
...
Wenn Sie Ihr Startlaufwerk neu erstellen müssen, verwenden Sie dieses Backup mit dem [USB Creator Tool](https://unraid.net/download) über die Option **Benutzerdefiniert verwenden**.
