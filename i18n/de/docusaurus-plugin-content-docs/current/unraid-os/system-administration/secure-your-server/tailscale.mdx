...
- **Funnel**: Veröffentlicht die Website des Containers über eine einzigartige HTTPS-URL im öffentlichen Internet. Jeder mit dem Link kann darauf zugreifen, auch wenn er nicht in Ihrem Tailnet ist. Verwenden Sie dies mit Vorsicht, da es Ihren Dienst dem gesamten Internet aussetzt.
  :::
...
- Für die meisten Benutzer bieten die Standardeinstellungen sicheren und zuverlässigen Zugriff. Erweiterte Optionen stehen für spezielle Netzwerk-Bedürfnisse zur Verfügung.
  :::
