...
| --------------------- | --------------------------------------------------------------------------------------------------- |
| **Servername**        | Set in ***Settings → Identification***. Default is `tower`.                                         |
| **Lokale TLD**        | Set in ***Settings → Management Access***. Default is `local`.                                      |
...
| **Myunraid.net**      | Für sicheren lokalen und Fernzugriff, insbesondere mit Unraid Connect oder wenn Sie ein vertrauenswürdiges Zertifikat wünschen.                            | Trusted by browsers, no warnings. Enables secure remote access via Unraid Connect.                                              |
