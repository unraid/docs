...
| VPN-getunnelter Zugang          | Leiten Sie spezifische Docker-Container und %%VM\|vm%%s über einen kommerziellen %%WireGuard\|wireguard%% VPN-Anbieter.     |
...
2. ✅ Der Tunnel ist auf sowohl Unraid als auch auf den Client-Geräten aktiv. *(„Aktiv“ bedeutet, dass der Tunnel gestartet wurde, aber nicht unbedingt verbunden ist.)*
...
3. ✅ DDNS-URL zeigt auf Ihre aktuelle öffentliche IP und ist im **Lokalen Endpunkt** festgelegt.
