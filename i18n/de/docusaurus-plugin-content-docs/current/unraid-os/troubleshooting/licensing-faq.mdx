...
<div style={{ display: "flex", justifyContent: "center", margin: "20px 0" }}>
  ...
  -------------------- | ------------------------ | ---------------------- | |
  Starter → Unleashed | 69 $ USD | Unbegrenzt² | | Starter → Lifetime | 209 $
  USD | Unbegrenzt² | | Unleashed → Lifetime | 149 $ USD | Unbegrenzt² | | Basic
  → Unleashed | 49 $ USD | Unbegrenzt² | | Plus → Unleashed | 19 $ USD |
  Unbegrenzt² | | Basic → Plus | 89 $ USD | Bis zu 12 Geräte¹ | | Basic → Pro |
  139 $ USD | Bis zu 30 Geräte¹ | | Plus → Pro | 109 $ USD | Bis zu 30 Geräte¹ |
</div>

**Jährliche Verlängerungsgebühr** (nur Starter & Unleashed): 36 $ USD

<sup>1</sup> Angeschlossene Speichermedien bezieht sich auf die Gesamtzahl der
...
<sup>2</sup> „Unbegrenzt“ bedeutet, dass Sie nicht durch die Lizenz, sondern
