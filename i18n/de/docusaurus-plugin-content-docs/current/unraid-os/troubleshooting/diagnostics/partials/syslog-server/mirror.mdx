...
Die **Einstellung, %%syslog|syslog%% beim Herunterfahren auf USB-Stick zu kopieren**, ist sicher für Ihren USB-Stick. Das Aktivieren von **Spiegeln auf USB-Stick** kann jedoch zu übermäßigen Schreibvorgängen führen, wenn es über einen längeren Zeitraum eingeschaltet bleibt. Für langfristige Protokollierungsanforderungen sollten Sie stattdessen die Verwendung eines lokalen oder entfernten %%syslog-Servers|syslog-server%% in Betracht ziehen.
