...
## Permanente Protokolle (Syslog-Server) {/* #persistent-logs-syslog-server */}
...
<Tabs>
  <TabItem value="Spiegeln" label="Mirror syslog to boot drive" default>
    <SyslogMirror />
  </TabItem>
