...
<details>
  ...
  2. Führen Sie regelmäßige [parity checkss](../../using-unraid-to/manage-storage/array/array-health-and-maintenance.mdx#parity-checks) durch, um die Datenintegrität sicherzustellen.
