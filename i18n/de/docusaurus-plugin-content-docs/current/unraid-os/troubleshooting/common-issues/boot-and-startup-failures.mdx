...
1. Das Boot-Volume wird unter `/boot` eingehängt.
...
3. Verwenden Sie den `df`-Befehl, um zu überprüfen, ob `/boot` eingehängt ist.
4. Das Boot-Volume muss für das korrekte Einhängen mit **UNRAID** (alles in Großbuchstaben) beschriftet sein.
