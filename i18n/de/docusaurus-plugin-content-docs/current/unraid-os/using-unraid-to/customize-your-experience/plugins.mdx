...
Wenn ein Plugin in den **[Community Applications](/community-applications/)** verfügbar ist, wird empfohlen, es aus der Registerkarte **Apps** zu installieren, um zusätzliche Überprüfungen und Kompatibilitätschecks durchzuführen.
