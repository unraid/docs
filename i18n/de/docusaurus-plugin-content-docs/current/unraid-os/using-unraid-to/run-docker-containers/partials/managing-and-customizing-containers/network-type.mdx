...
Docker hat eine Einschränkung, die verhindert, dass es an zwei Netzwerken teilnimmt, die dasselbe Subnetz teilen. Wenn Sie zwischen einer kabelgebundenen und einer drahtlosen Verbindung wechseln, müssen Sie Docker neu starten und alle vorhandenen Container neu konfigurieren, um die neue Schnittstelle zu nutzen. Diese [Netzwerkkonfiguration](/unraid-os/system-administration/secure-your-server/securing-your-connection) änderung erfordert eine Neukonfiguration der Container.
:::
