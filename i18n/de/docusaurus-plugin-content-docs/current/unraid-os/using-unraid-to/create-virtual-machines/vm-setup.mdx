...
<details>
  ...
  **BIOS-Typ:**
  ...
  :::note
  Der BIOS-Typ kann nur beim Erstellen einer neuen %%VM|vm%% eingestellt werden.
  :::
...
<details>
  ...
  :::note
  Sie können einen %%vDisk|vdisk%% im Unraid GUI nicht verkleinern; nur die Erweiterung wird unterstützt.
  :::
  ...
  :::tip
  Sichern Sie Ihre %%VM|vm%% immer, bevor Sie Festplattenänderungen vornehmen.
  :::
</details>
...
<details>
  ...
  :::tip
  Wenn dies häufig passiert, überprüfen Sie die Startreihenfolge Ihrer VM und stellen Sie sicher, dass der richtige %%vDisk|vdisk%% oder die ISO als primäres Startgerät in den VM-Einstellungen festgelegt ist.
  :::
</details>
...
<details>
  ...
  :::note
  Für detaillierte Erklärungen zu %%IOMMU|iommu%%-Gruppen empfehlen wir, [Alex Williamsons Blog](http://vfio.blogspot.com/2014/08/iommu-groups-inside-and-out.html) anzusehen.
  :::
</details>
