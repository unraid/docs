...
- Einige USB-Geräte funktionieren möglicherweise nicht zuverlässig mit Passthrough - testen Sie und konsultieren Sie die [Unraid-Foren](https://forums.unraid.net/) für gerätespezifische Ratschläge.
  :::
