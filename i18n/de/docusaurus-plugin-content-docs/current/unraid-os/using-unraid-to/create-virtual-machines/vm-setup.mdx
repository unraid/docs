...
<Tabs>
  <TabItem value="erstellen" label="Snapshots erstellen" default>
    ...
    - Bewahren Sie Snapshots für wichtige Meilensteine auf, löschen Sie jedoch alte, um Speicherplatz zu sparen.
  ...
  <TabItem value="verwalten" label="Snapshots verwalten">
    ...
    **Snapshot entfernen**: Dies löscht einfach die Snapshot-Overlay-Datei, ohne Ihre %%VM|vm%% zu beeinflussen. Ihre %%VM|vm%% nutzt weiterhin die Original-Festplattendatei, und alle nach dem Snapshot vorgenommenen Änderungen gehen verloren.
  ...
  <TabItem value="revert" label="Zurück zu Snapshots wechseln">
    ...
    Das Zurücksetzen auf einen Snapshot löscht dauerhaft alle nach dessen Erstellung vorgenommenen Änderungen. Stellen Sie sicher, dass Sie diese Änderungen wirklich verlieren möchten, bevor Sie zurücksetzen.
