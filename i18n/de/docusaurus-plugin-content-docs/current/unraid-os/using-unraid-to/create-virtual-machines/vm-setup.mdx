...
12. Weisen Sie bei Bedarf **USB-Geräte** zu.
    ...
    - Das Unraid-Startgerät (USB) steht nicht zur Zuweisung zur Verfügung.
...
1. Bewegen Sie den Mauszeiger über eine Benutzervorlage und klicken Sie auf den Pfeil, um sie auf Ihren Server zu exportieren oder herunterzuladen.
2. Verwenden Sie auf einem anderen Unraid-System **Import aus Datei** oder **Hochladen**, um die Vorlage hinzuzufügen.
...
<Tabs>
  ...
  <TabItem value="zurückstellen" label="Zurück zu Snapshots wechseln">
...
2. **Emuliert**: Verwendet ein generisches CPU-Modell, reduziert Kompatibilitätsprobleme, begrenzt jedoch die Leistung.
...
- Weitere Informationen finden Sie in den Schritten zur Gerätebindung und zum Passthrough auf dieser Seite.
