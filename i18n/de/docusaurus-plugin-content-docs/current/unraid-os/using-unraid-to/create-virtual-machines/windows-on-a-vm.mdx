...
Das Erweitern oder Ändern von %%vDisk|vdisk%%- und Partitionslayouts kann zu irreversibrem Datenverlust führen, wenn es nicht sorgfältig durchgeführt wird. Erstellen Sie vor dem Fortfahren immer ein vollständiges Backup oder einen [Snapshot](./vm-setup.mdx#vm-snapshots) Ihrer %%VM|vm%%.
