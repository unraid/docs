...
Windows Search indiziert kontinuierlich den %%Virtual Machine|vm%%-Speicher, um Dateien für schnellere Suchergebnisse zu katalogisieren. Auf einer %%Virtual Machine|vm%% kann dies jedoch unnötigen Festplatten-I/O verursachen, zu Leistungsproblemen führen und den Verschleiß Ihres physischen Speichers erhöhen, besonders bei SSDs in Ihrem [%%Cache Pool|cache-pool%%](../manage-storage/cache-pools.mdx).
