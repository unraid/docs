...
<details>
  <summary><strong>1. Bereiten Sie das Flash-Laufwerk für die VM vor</strong> - Zum Erweitern/Zusammenklappen klicken</summary>

  Die Vorbereitung Ihres Flash-Laufwerks ist entscheidend für einen nahtlosen und zuverlässigen Startprozess der %%VM|vm%%. So richten Sie Ihre %%VM|vm%% Umgebung mit einem einzigartigen und richtig konfigurierten Startgerät ein.
...
7. Klicken Sie erneut auf **Update**. Die %%VM|vm%% sollte jetzt normal starten.
