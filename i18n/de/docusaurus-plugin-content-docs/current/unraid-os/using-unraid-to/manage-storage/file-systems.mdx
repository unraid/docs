...
- **Für gemischte oder wachsende Pools:** %%BTRFS|btrfs%% ist ideal, wenn Sie unterschiedliche Laufwerkgrößen nutzen oder Geräte flexibel hinzufügen oder entfernen möchten. Siehe [BTRFS-Pools](/de/unraid-os/using-unraid-to/manage-storage/cache-pools#btrfs-pools) für Details zum Hinzufügen von Datenträgern zu %%BTRFS|btrfs%%-Pools.
