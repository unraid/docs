...
- **Für gemischte oder wachsende Pools:** %%BTRFS|btrfs%% ist ideal, wenn Sie unterschiedliche Laufwerkgrößen nutzen oder Geräte flexibel hinzufügen oder entfernen möchten. Siehe [BTRFS-Pools](../cache-pools.mdx#btrfs-pools) für Details zum Hinzufügen von Datenträgern zu %%BTRFS|btrfs%%-Pools.
...
<a id="using-the-unassigned-devices-plugins"></a>
