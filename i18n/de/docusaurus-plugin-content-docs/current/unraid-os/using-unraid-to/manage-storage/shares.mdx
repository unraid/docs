...
Sie können den [Mover-Zeitplan](../../getting-started/set-up-unraid/customize-unraid-settings.mdx#scheduler) konfigurieren, indem Sie zu **Einstellungen → Zeitplaner → Mover-Einstellungen** gehen. Wenn er automatisch außerhalb der Stoßzeiten ausgeführt wird, hilft das dabei, Dateien zwischen dem %%cache|Cache%% und dem %%array|Array%% zu verschieben, ohne dass manuelles Eingreifen erforderlich ist.
