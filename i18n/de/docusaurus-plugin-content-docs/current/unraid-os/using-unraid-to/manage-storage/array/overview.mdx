...
1. Navigieren Sie zu ***Einstellungen → Festplatteneinstellungen***.
...
\**Die tatsächlichen NVMe-Geschwindigkeiten hängen von PCIe-Generation, Kühlung und Netzwerk-Bandbreite ab (z.B. 10GbE begrenzt auf ~1.100 MB/s).*
