...
9. Verify disk health by running a [SMART extended test](../../../../system-administration/advanced-tools/command-line-interface#smartctl) and acknowledging any warning icons in the dashboard.
