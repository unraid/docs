...
Zur Vereinfachung können Sie diese Überprüfungen so planen, dass sie automatisch zu Intervallen durchgeführt werden, die zu Ihnen passen, indem Sie zu ***Einstellungen → Zeitplaner*** navigieren. Es wird empfohlen, automatische, korrigierende Prüfungen monatlich oder vierteljährlich durchzuführen, um die kontinuierliche Gesundheit Ihrer Daten zu gewährleisten und gefundene Synchronisierungsfehler zu beheben.
...
Wenn Ihr Array nicht startet, folgen Sie diesen Schritten, um häufige Probleme zu identifizieren und zu beheben. Suchen Sie nach Fehlermeldungen unter ***Haupt → Array-Betrieb***.
