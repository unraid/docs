...
Zur Bequemlichkeit können Sie diese Prüfungen automatisch in für Sie geeigneten Intervallen im Menü ***Einstellungen → Scheduler*** planen. Es ist ratsam, monatlich oder vierteljährlich automatisierte, korrigierende Überprüfungen durchzuführen, um die kontinuierliche Gesundheit Ihrer Daten zu gewährleisten und gefundene Synchronisierungsfehler zu beheben.
...
Wenn Ihr Array nicht startet, befolgen Sie diese Schritte zur Identifizierung und Behebung häufiger Probleme. Suchen Sie nach Fehlermeldungen unter ***Haupt → Array-Operationen***.
