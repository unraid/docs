...
Balance-Vorgänge können je nach Datenmenge im Pool, Laufwerksgeschwindigkeiten und der Komplexität des ausgewählten %%RAID|raid%%-Levels mehrere Stunden bis Tage dauern.
