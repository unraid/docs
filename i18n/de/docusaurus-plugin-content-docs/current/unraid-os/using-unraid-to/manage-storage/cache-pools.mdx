...
<Tabs>
  ...
  <TabItem value="Befehlszeile" label="Using the Command Line (Advanced)">
...
| %%RAID\|raid%% Level | Datenschutz     | Speichereffizienz | Use Case                                                                                       |
| -------------------- | --------------- | ----------------- | ---------------------------------------------------------------------------------------------- |
| Single               | Keine           | 100%              | Temporary storage or non-critical data where redundancy isn't needed.                          |
| %%RAID 0\|raid0%%    | Keine           | 100%              | Maximizes performance and capacity, but not recommended for critical data.                     |
...
| Anwendungsfall               | Configuration example                                                      | Benefit                               |
| ---------------------------- | -------------------------------------------------------------------------- | ------------------------------------- |
