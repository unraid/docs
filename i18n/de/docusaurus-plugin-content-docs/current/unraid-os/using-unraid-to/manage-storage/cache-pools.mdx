...
- **Einzel-vdev RAIDZ1/2/3-Pools:** Ein Pool mit einer Gruppe von Laufwerken in einer RAIDZ-Konfiguration. Kann Laufwerk für Laufwerk erweitert werden. Siehe [RAIDZ-Erweiterung](#raidz-erweiterung) unten.
