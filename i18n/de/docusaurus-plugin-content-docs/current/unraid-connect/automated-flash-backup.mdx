...
- Melden Sie sich bei Unraid Connect an.
- Wählen Sie **Details** auf dem Dashboard.
- Klicken Sie auf **Flash-Backup generieren** aus der Flash-Backup-Kachel.
- Das System erstellt eine ZIP-Datei, die Ihre OS-Konfiguration und Versionsinformationen enthält.
