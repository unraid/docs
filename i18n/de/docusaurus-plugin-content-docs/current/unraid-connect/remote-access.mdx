...
Für die meisten Benutzer ist die offizielle [Tailscale-Integration](../unraid-os/system-administration/secure-your-server/tailscale.mdx) die bessere Wahl für die Fernverwaltung, da sie verhindert, dass das %%WebGUI|web-gui%% dem öffentlichen Internet ausgesetzt wird. Verwenden Sie Unraid Connect Remote Access nur dann, wenn Sie ausdrücklich Browserzugriff auf die öffentlich erreichbare URL des %%WebGUI|web-gui%% benötigen.
