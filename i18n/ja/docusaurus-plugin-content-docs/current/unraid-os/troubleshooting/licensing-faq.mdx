...
<span id="own-license"></span>

### 自分のソフトウェアライセンスは自分のものですか？
...
<span id="redeem-activation-code"></span>

### ライセンスのアクティベーションコードはどのように引き換えますか？
...
<span id="oem-purchase"></span>

### 私は再販業者/OEMで、顧客の代わりにライセンスを購入する必要があります。どうすればよいですか？
...
<span id="upgrade-license"></span>

### Unraid ライセンスはどのようにアップグレードしますか？
...
<span id="manual-keyfile-install"></span>

### USB フラッシュデバイスにライセンスキーファイルを手動でインストールするにはどうすればよいですか？
#### 手動（オフライン）方法
...
<span id="registration-type"></span>
...
<span id="license-types--features"></span>

## ライセンスタイプと機能
<span id="subscription"></span>

### Unraid OS はサブスクリプションですか？
...
<span id="no-extension"></span>

### Starter または Unleashed ライセンスの延長をしないとどうなりますか？
...
<span id="pre-release-policy"></span>

### プレリリース（Beta/RC 版）では何が起こりますか？
...
<span id="unlimited-storage"></span>

### 接続されたストレージデバイスにおける「無制限」とはどういう意味ですか？
...
<span id="usb-failure-license"></span>

### USB フラッシュデバイスが故障した場合はどうなりますか？ ライセンスを再購入する必要がありますか？
...
<span id="guid-error"></span>

### フラッシュデバイスの登録時に次のエラーが出た場合はどうすればよいですか: '####-####-####-#############' はすでに別のユーザーに登録されています？
...
<span id="trial-license"></span>

### Unraid のトライアルはどのように機能しますか？
...
<span id="extend-trial"></span>

### トライアルを延長するにはどうすればよいですか？
...
<span id="trial-key-transfer"></span>

### トライアルキーを新しいフラッシュデバイスに移行できますか？
