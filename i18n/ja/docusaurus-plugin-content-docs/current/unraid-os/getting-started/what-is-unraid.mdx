  ...
  ```mdx-code-block
    ...
    <div className="flex-container">
      <figure className="flex-figure">
        <img src="/img/User_shares_-_distribution@500px.png" alt="ユーザー共有の分布の例" />

        <figcaption>ユーザー共有 - 分布</figcaption>
      </figure>

      <figure className="flex-figure">
        <img src="/img/User_shares_-_access@500px.png" alt="ユーザー共有アクセスの例" />
