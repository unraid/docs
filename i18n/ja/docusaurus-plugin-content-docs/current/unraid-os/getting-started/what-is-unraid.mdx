...
<details>
  <summary><h3>ソフトウェア定義NAS</h3>ユーザーがネットワーク上でストレージ容量を効率的に共有できるようにします。</summary>
  ...
  <details>
    <summary><strong>パリティの仕組み</strong> - クリックして展開/折りたたみ</summary>
...
<details>
  <summary><h3>アプリケーションサーバー</h3>コンテナ化されたアプリケーションの実行を可能にします。</summary>
  ...
  Dockerコンテナを使用すると、%%virtual machines|vm%%に伴うオーバーヘッドなしで、隔離された軽量な環境でアプリケーションを実行できます。Unraidは、[Docker Hub](https://hub.docker.com/)と[Community Applications](/community-applications/)を通じて、事前設定済みの数千ものアプリにアクセスできるようにすることで、Dockerの利用を簡単にします。このコンテナ化されたアプローチにより、Unraidユーザーは互換性の問題なく複数のアプリケーションを同時に実行できます。また、自己完結型のアプリケーションパッケージを使用することでシステムを整理しやすくし、Dockerのエコシステムを通じてサーバー機能を簡単に拡張できます。
...
<details>
  <summary><h3>仮想化プラットフォーム</h3>ベアメタルに近い性能で仮想マシンを実行します。</summary>
  ...
  <details>
    <summary><strong>仮想マシン（VM）の利用による利点</strong> - クリックして展開/折りたたみ</summary>
  ...
  <details>
    <summary><strong>仮想化向けの割り当て可能デバイスのサポート</strong> - クリックして展開/折りたたみ</summary>
