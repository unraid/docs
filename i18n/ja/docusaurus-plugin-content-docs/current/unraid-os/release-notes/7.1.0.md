...
- mover:
  ...
  - 修正: [mover を使用して array disk を空にする](7.0.0.md#using-mover-to-empty-an-array-disk)際、対応する share.cfg ファイルを持つ最上位フォルダーのみを移動するようになり、さらに *移動されなかった* ファイル一覧の表示を妨げていたバグも修正しました。
