...
#### Ext2/3/4、NTFS、exFAT のサポート {/* #ext234-ntfs-and-exfat-support */} {/* #ext234-ntfs-and-exfat-support */}
...
Unraid.net アカウントまたは他の OIDC 準拠プロバイダーを使用して、Single Sign-On (SSO) で Unraid の WebGUI にログインします。この *オプション* 機能の詳細は、Docs の [OIDC Provider Setup](../../API/oidc-provider-setup.mdx) を参照してください。
...
- 機能: ***Users → Root → SSH authorized keys*** が、より多くの形式をサポートするようになりました（[wandercone](https://github.com/wandercone) に感謝）
