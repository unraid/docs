...
#### 手順 1: VM が Xen の GPLPV ドライバーを使用しているか確認する
...
#### 手順 2: GPLPV ドライバー削除のために Windows を準備する
