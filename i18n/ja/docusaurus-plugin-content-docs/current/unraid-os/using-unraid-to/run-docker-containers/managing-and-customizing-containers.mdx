...
| **プロジェクトページ** | Opens the container's project page for documentation and support.                                   |
...
<Tabs>
  <TabItem value="開始" label="Start container" default>
    <DockerCommandStart />
  </TabItem>

  <TabItem value="停止" label="Stop container">
    <DockerCommandStop />
  </TabItem>

  <TabItem value="再起動" label="Restart container">
    <DockerCommandRestart />
  </TabItem>

  <TabItem value="ステータス" label="Check container status">
    <DockerCommandStatus />
  </TabItem>

  <TabItem value="ログ" label="Show container logs">
    <DockerCommandLogs />
  </TabItem>
</Tabs>
