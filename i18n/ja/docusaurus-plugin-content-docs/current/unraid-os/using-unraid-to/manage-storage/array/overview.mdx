...
| ------------------------- | ---------------------------------------- | ----------- | ---------------------------- | ---------------- | --------------------------------------------------------------------- |
| Read/Modify/Write         | 20–40 MB/s                               | Low         | Only parity and target drive | はい               | Most workloads, energy savings, small writes                          |
| Turbo Write (Reconstruct) | 40–120 MB/s                              | High        | All drives                   | はい               | Large file transfers, array rebuilds, %%parity checks\|parity-check%% |
...
| 機能                      | Cache pool (BTRFS)                                                                                               | Cache pool (ZFS)                                                                                                           | Main array (Unraid)                                |
| ----------------------- | ---------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------- |
