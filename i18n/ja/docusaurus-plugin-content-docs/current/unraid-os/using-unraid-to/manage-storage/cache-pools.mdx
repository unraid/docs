...
| -------------------- | --------------- | ---------------- | ---------------------------------------------------------------------------------------------- |
| Single               | なし              | 100%             | Temporary storage or non-critical data where redundancy isn't needed.                          |
| %%RAID 0\|raid0%%    | なし              | 100%             | Maximizes performance and capacity, but not recommended for critical data.                     |
...
| ユースケース                       | Configuration example                                                      | Benefit                               |
| ---------------------------- | -------------------------------------------------------------------------- | ------------------------------------- |
