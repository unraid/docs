...
### ブートデバイスのバックアップ {/* #backing-up-your-flash-device */}
...
### 交換方法 {/* #backing-up-your-flash-device */}
...
7. **Parity が有効** であることを確認した場合は、構成が正しいことを確認するために、修正[パリティチェック](../../using-unraid-to/manage-storage/array/array-health-and-maintenance.mdx#parity-checks)を実行してください。
