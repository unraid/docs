...
[Community Applications](/community-applications/)（***Apps tab***）で「DiskSpeed」を検索して DiskSpeed をインストールするか、手動インストール手順については [GitHub リポジトリ](https://github.com/jbartlett777/DiskSpeed) を参照してください。
...
「使用可能」メモリの値が低くても、必ずしも問題を示すわけではありません。Linux はパフォーマンス向上のためにデータを積極的にキャッシュします。
...
## blockdev の使い方を表示 {/* #file-transfer-operations */}
...
<details>
  <summary><strong>コマンドライン転送手順を表示</strong> - クリックして展開/折りたたみ</summary>
