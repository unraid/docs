...
Unraid OS を更新すると、最新の機能、セキュリティ更新、およびハードウェアサポートを利用できます。このページでは、標準的な更新手順と、トラブルシューティングのヒントおよび手動更新オプションについて説明します。

Stable、Beta、Release Candidate（RC）ビルドのどれを選ぶか迷った場合は、[Unraid OS リリース種類](./release-types.mdx) を参照してください。

:::note\[Prerequisites]

更新を始める前に、ブートデバイスの完全なバックアップを作成してください。詳細は、[ブートデバイスのバックアップ](../system-administration/maintain-and-update/changing-the-flash-device.mdx#backing-up-your-flash-device) を参照してください。
...
## 標準更新手順 {/* #standard-update-process */}
...
手動ダウングレードが必要なのは、%%WebGUI|web-gui%% にアクセスできない場合、またはダウングレードのオプションが利用できない場合だけです。続行する前に、USB フラッシュデバイスをバックアップすることが重要です。詳細については、[フラッシュデバイスのバックアップ](../system-administration/maintain-and-update/changing-the-flash-device.mdx#backing-up-your-flash-device) を参照してください。
