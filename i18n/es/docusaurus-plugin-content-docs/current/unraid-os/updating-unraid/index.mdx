---
sidebar_position: 1
sidebar_label: Actualizando Unraid
---
...
Para obtener ayuda para decidir entre compilaciones Stable, Beta y Release Candidate (RC), consulta [Tipos de lanzamiento de Unraid OS](./release-types.mdx).

:::note\[Prerequisites]

Antes de comenzar a actualizar, asegúrate de crear una copia de seguridad completa de tu dispositivo de arranque. Para más detalles, consulta [Cómo hacer una copia de seguridad de tu dispositivo de arranque](../system-administration/maintain-and-update/changing-the-flash-device.mdx#backing-up-your-flash-device).
...
Las degradaciones manuales solo son necesarias si no puedes acceder al %%WebGUI|interfaz web%% o si la opción de degradación no está disponible. Antes de proceder, es importante respaldar tu dispositivo USB flash. Para más detalles, consulta [Respaldo de tu dispositivo flash](../system-administration/maintain-and-update/changing-the-flash-device.mdx#backing-up-your-flash-device).
