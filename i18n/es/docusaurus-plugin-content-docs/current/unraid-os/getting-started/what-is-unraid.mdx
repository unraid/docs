...
<details>
  ...
  Los contenedores de Docker te permiten ejecutar aplicaciones en entornos aislados y ligeros sin la sobrecarga asociada con las %%virtual machines|máquinas virtuales%%. Unraid simplifica el uso de Docker proporcionando acceso a miles de aplicaciones preconfiguradas a través de [Docker Hub](https://hub.docker.com/) y [Community Applications](/community-applications/). Este enfoque basado en contenedores permite a los usuarios de Unraid ejecutar varias aplicaciones simultáneamente sin problemas de compatibilidad. También ayuda a mantener el sistema organizado mediante el uso de paquetes de aplicaciones autocontenidos y facilita la mejora de las capacidades del servidor a través del ecosistema de Docker.
