...
<details>
  ...
  <details>
    ...
    En la imagen de arriba, tres unidades contienen secuencias de bits que varían según el tamaño del dispositivo. Estas unidades están desprotegidas, por lo que si una falla, se perderán los datos. Para proteger contra fallos, necesitamos un cuarto disco como %%parity disk|parity-drives%%, el cual debe ser igual o mayor que el disco de datos más grande.
