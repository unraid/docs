...
### ¿Cómo funciona la copia de seguridad de la memoria flash si uso arranque interno?
...
No coloques manualmente los archivos de copia de seguridad de la memoria flash en la partición de arranque interno.

Para ver los pasos completos de copia de seguridad y restauración, consulta [Automated flash backup](/unraid-connect/automated-flash-backup/).
