...
Si las dos extensiones adicionales no se utilizaron y esta opción no aparece para ti, o si no funciona por alguna razón, envíanos el GUID de la unidad flash desde **Herramientas > Registro** a [contact@unraid.net](mailto:contact@unraid.net) o a través de nuestro portal de soporte en [support.unraid.net](https://support.unraid.net/support/home) y estaremos encantados de ayudarte.
