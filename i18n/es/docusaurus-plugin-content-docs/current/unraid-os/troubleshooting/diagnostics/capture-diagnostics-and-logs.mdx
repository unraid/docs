...
Ejecuta esta prueba varias veces para obtener una referencia más confiable. Por ejemplo, puedes usar el siguiente comando para ejecutar la prueba 12 veces:
...
<Tabs>
  <TabItem value="espejo" label="Reflejar syslog en la unidad de arranque" default>
    <SyslogMirror />
  </TabItem>
