...
- **Docker y la información de %%VM|vm%%**: Configuración general para Docker y máquinas virtuales (no se incluye información sobre sus contenedores individuales o %%VMs|vm%%).
  :::
...
Aunque estas pruebas no le proporcionarán velocidades exactas de transferencia de archivos del mundo real, pueden señalar discos con bajo rendimiento y cualquier cuello de botella en el controlador.
:::
