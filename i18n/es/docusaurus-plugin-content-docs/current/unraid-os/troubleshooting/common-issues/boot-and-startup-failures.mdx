...
1. El volumen de arranque se monta en `/boot`.
...
3. Usa el comando `df` para comprobar si `/boot` está montado.
4. El volumen de arranque debe estar etiquetado como **UNRAID** (todo en mayúsculas) para un montaje adecuado.
