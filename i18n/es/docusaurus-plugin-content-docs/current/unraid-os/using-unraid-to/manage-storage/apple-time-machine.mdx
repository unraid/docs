...
:::caution[Vuelo de macOS Sequoia (15.x)]
Algunos usuarios informan problemas intermitentes con Time Machine y comparticiones de red en macOS Sequoia. Si experimentas fallos en las copias de seguridad, considera usar el [contenedor Docker de Time Machine](https://unraid.net/community/apps?q=time+machine#r) como alternativa.
:::
