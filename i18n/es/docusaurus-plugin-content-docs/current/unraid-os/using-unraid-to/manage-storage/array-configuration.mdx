...
<details>
  <summary><strong>En profundidad: ¿Cómo se reconstruyen los datos utilizando la paridad?</strong> - Haz clic para expandir/colapsar</summary>
...
<details>
  <summary><strong>¿Qué tamaño debe tener mi disco de paridad?</strong> - Haz clic para expandir/colapsar</summary>
...
<details>
  <summary><strong>En profundidad: ¿Cómo funciona la Paridad Dual?</strong> - Haz clic para expandir/colapsar</summary>
...
<details>
  ...
  Cuando necesite reemplazar un disco, asegúrese de que el nuevo disco sea al menos tan grande como el disco fallido, pero no más grande que su disco de paridad más pequeño. Si debe usar un disco más grande, siga el procedimiento de **Intercambio de Paridad**.
...
- **Reordenación de discos:** Cambiar el orden de los discos no afectará a paridad1, pero *puede* invalidar paridad2.
  :::
...
| -------------------------------- | ---------------------------------------- | -------------- | ------------------------------------ | ----------------------- | ------------------------------------------------------------------------------------------------- |
| Leer/Modificar/Escribir          | 20–40 MB/s                               | Bajo           | Solo la paridad y la unidad objetivo | Yes                     | La mayoría de las cargas de trabajo, ahorro de energía, escrituras pequeñas                       |
| Turbo Escritura (Reconstrucción) | 40–120 MB/s                              | Alta           | Todas las unidades                   | Yes                     | Transferencias de archivos grandes, reconstrucciones del arreglo, %%parity checks\|parity-check%% |
