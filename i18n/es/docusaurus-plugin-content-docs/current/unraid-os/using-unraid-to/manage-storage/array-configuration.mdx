...
Para obtener información más detallada sobre cache pools, incluyendo cómo configurarlos, gestionarlos y características avanzadas, consulte la página [Pools de Caché](./cache-pools.mdx).
