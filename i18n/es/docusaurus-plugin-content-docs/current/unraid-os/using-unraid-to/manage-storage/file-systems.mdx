...
- Para las unidades de transferencia o dispositivos externos, se recomienda usar el complemento **[Dispositivos No Asignados](#using-the-unassigned-devices-plugins)**, que admite sistemas de archivos adicionales.
  :::
...
Si no está seguro, comenzar con los valores predeterminados es un buen enfoque: use %%XFS|xfs%% para las unidades %%array|matriz%% y %%BTRFS|btrfs%% para las %%cache pools|pools de caché%%.
:::
...
- Cualquier unidad formateada en una versión anterior de XFS necesita ser migrada antes del 2030.
  :::
