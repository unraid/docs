...
- **Para pools mixtos o en expansión:** %%BTRFS|btrfs%% es ideal si deseas utilizar diferentes tamaños de unidades o agregar o quitar dispositivos fácilmente. Consulta [Pools BTRFS](../cache-pools.mdx#pools-btrfs) para obtener detalles sobre cómo agregar discos a los pools %%BTRFS|btrfs%%.
