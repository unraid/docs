...
| %%RAID 1\|raid1%%    | 1 fallo de disco    | 50%                 | Default for Unraid pools. Ideal for Docker/%%VM\|vm%% storage and critical data.                                        |
...
| ------------------------------------ | -------------------------------------------------------------------------- | -------------------------------------------------- |
| VM de alto rendimiento               | NVMe SSD pool, %%RAID 1\|raid1%%, %%BTRFS\|btrfs%% or %%ZFS\|zfs%%         | Entrada/salida rápida con redundancia              |
