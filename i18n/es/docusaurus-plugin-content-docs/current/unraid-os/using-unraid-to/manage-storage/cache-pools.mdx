...
En Unraid, un %%cache pool|cache-pool%% es una colección de uno o más discos, generalmente SSDs o HDDs de alta velocidad. Estos discos almacenan temporalmente datos antes de ser movidos a tu [%%array|array%%](/unraid-os/using-unraid-to/manage-storage/array/overview) principal. Usar %%cache pools|cache-pool%% puede mejorar significativamente las velocidades de escritura, proteger tus datos y proporcionar almacenamiento dedicado para tareas específicas como ejecutar contenedores Docker o [%%virtual machines|vm%%](../create-virtual-machines/overview-and-system-prep.mdx).
...
<a id="converting-a-pool-to-btrfs-or-zfs"></a>
...
<a id="changing-pool-raid-levels"></a>
...
<a id="moving-files-between-a-pool-and-the-array"></a>
