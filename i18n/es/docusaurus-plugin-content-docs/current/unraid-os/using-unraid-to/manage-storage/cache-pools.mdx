...
- Si tu compartir utiliza un %%cache pool|cache-pool%% como **almacenamiento principal**, los archivos van al pool hasta que alcanza el espacio libre mínimo, luego se envían directamente al %%array|array%%.
...
| Descargas de medios masivos          | Gran pool de HDD, %%RAID 0\|raid0%% o individual, %%XFS\|xfs%%/%%BTRFS\|btrfs%% | Alta capacidad con menos redundancia               |
