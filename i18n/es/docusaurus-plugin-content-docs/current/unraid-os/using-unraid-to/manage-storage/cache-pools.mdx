...
Unraid permite crear y gestionar hasta 35 grupos de almacenamiento separados, cada uno con hasta 200 dispositivos. Varios grupos le brindan flexibilidad para asignar almacenamiento a distintas tareas, mejorar el rendimiento y personalizar la redundancia según sus necesidades. Cada grupo puede utilizar un sistema de archivos, nivel de %%RAID|raid%% y tipo de dispositivo (SSD, HDD, NVMe, etc.) diferentes.
