...
<Tabs>
  ...
  <TabItem value="línea de comandos" label="Using the Command Line (Advanced)">
...
| %%RAID\|raid%% Level | Protección de Datos | Eficiencia Espacial | Use Case                                                                                       |
| -------------------- | ------------------- | ------------------- | ---------------------------------------------------------------------------------------------- |
| Single               | Ninguno             | 100%                | Temporary storage or non-critical data where redundancy isn't needed.                          |
| %%RAID 0\|raid0%%    | Ninguno             | 100%                | Maximizes performance and capacity, but not recommended for critical data.                     |
...
| Caso de uso                  | Configuration example                                                      | Benefit                               |
| ---------------------------- | -------------------------------------------------------------------------- | ------------------------------------- |
