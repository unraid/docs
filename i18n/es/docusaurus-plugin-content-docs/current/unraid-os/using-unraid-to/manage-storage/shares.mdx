...
1. Vacía la compartición:
   ...
   - **Usar acceso a la red**: Conéctate a través de **Explorer de Windows** (%%SMB|samba%%) o **Finder de macOS** (%%AFP|AFP%%/%%SMB|samba%%) y elimina manualmente los archivos.

   :::precaución

   El comando `rm -rf` eliminará permanentemente los archivos. Verifica antes de usarlo. Asegúrate de que ningún servicio de Docker o %%VM|vm%% esté usando la compartición antes de eliminarla.
