...
Cuando inicias servicios como Docker o %%VM|vm%% Manager, Unraid crea automáticamente un [conjunto de comparticiones de usuario por defecto](#default-shares) diseñadas para soportar complementos comunes, contenedores Docker y %%máquinas virtuales (VMs)|vm%%. Puedes crear cómodamente comparticiones adicionales para tus datos personales según sea necesario.
