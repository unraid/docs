...
:::info
%%ZFS|zfs%% no requiere ni es compatible con las utilidades tradicionales `fsck`. La naturaleza transaccional de %%ZFS|zfs%% significa que se mueve atómicamente de un estado consistente a otro, convirtiendo el escaneo en el método preferido para la verificación de integridad.
:::
