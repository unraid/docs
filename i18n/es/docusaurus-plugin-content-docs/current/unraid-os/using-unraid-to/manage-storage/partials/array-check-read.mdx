...
Para mantener la salud de sus discos, es prudente **programar verificaciones de lectura regulares|read-check** especialmente si su arreglo no tiene protección de paridad. Esta medida proactiva le ayudará a detectar problemas potenciales temprano y proteger sus datos.
