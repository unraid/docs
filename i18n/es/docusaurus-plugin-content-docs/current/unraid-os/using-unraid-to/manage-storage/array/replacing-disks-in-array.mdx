...
9. Verifique la salud del disco ejecutando un [SMART test extendido](/unraid-os/system-administration/advanced-tools/command-line-interface#smartctl) y reconociendo cualquier ícono de advertencia en el tablero.
