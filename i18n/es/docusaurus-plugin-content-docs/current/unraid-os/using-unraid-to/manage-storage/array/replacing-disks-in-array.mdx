...
9. Verifique la salud del disco ejecutando un [%%SMART|smart%% test extendido](/unraid-os/system-administration/advanced-tools/command-line-interface#smartctl) y reconociendo cualquier ícono de advertencia en el tablero.
...
- Has comprobado el estado del disco usando [informes SMART](../../../system-administration/monitor-performance/smart-reports-and-disk-health.mdx).
...
El intercambio de paridad es un procedimiento especial que se utiliza cuando necesita reemplazar un disco de datos por un disco más grande que su disco de paridad actual. El proceso instala un nuevo disco más grande como el nuevo disco de paridad y luego instala su disco de paridad anterior en la ranura de datos. Esto garantiza que su matriz siga protegida y permite el uso de discos de datos más grandes en el futuro.
