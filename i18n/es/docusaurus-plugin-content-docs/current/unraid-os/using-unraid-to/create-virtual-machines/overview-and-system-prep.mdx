...
| **Puente público (br0)** | Managed by Unraid. This option connects %%VMs\|vm%% directly to your LAN, with IPs assigned by your router. MAC addresses are preserved for consistent IP assignment.                                                               | Lo mejor para %%VMs\|vm%% que deben funcionar como dispositivos regulares en tu red, accesibles desde otros dispositivos. |
