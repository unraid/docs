...
:::note
La BIOS de tu placa base debe habilitar la virtualización asistida por hardware y el soporte para %%IOMMU|iommu%%. Busca configuraciones etiquetadas como “%%Intel VT-x|intel-vt-x%%,” “Intel VT-d,” “%%AMD-V|amd-v%%,” o “AMD-Vi.”
:::
