...
12. Asigne **Dispositivos USB** según sea necesario.
    ...
    - El dispositivo de arranque USB de Unraid no está disponible para asignación.
...
1. Pase el cursor sobre una plantilla de usuario y haga clic en la flecha para exportarla a su servidor o descargarla.
2. En otro sistema Unraid, use **Importar desde archivo** o **Cargar** para añadir la plantilla.
...
<Tabs>
  ...
  <TabItem value="revertir" label="Revirtiendo a instantáneas">
...
:::info[Advanced conceptos de instantáneas]
...
2. **Emulado**: Usa un modelo de CPU genérico, reduciendo problemas de compatibilidad pero limitando el rendimiento.
...
- Para más información, revisa los pasos de vinculación de dispositivos y passthrough en esta página.
...
%%GPU passthrough|gpu-passthrough%% te permite asignar directamente una tarjeta gráfica física a un %%VM|vm%%, proporcionando un rendimiento casi nativo para juegos, trabajo creativo o aprendizaje automático.
