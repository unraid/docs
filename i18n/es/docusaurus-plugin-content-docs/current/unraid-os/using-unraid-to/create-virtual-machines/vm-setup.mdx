...
<details>
  <summary><strong>Más características avanzadas</strong></summary>
...
- Algunos dispositivos USB pueden no funcionar de manera fiable con paso a través - pruebe y consulte los [foros de Unraid](https://forums.unraid.net/) para obtener consejos específicos sobre el dispositivo.
  :::
...
- **Flexibilidad:** Transforma tu servidor de Unraid en una estación de trabajo multipropósito.
  :::
