...
1. Navega a ***Herramientas → Dispositivos del Sistema*** en el %%WebGUI|web-gui%%.
...
<details>
  ...
  1. **Habilitar anulación de PCIe ACS:**
     - Ve a ***Configuraciones → Administrador de VM***.
     - Establece **anulación PCIe ACS** en *Descendente* o *Ambos*.
     - Reinicia Unraid.
