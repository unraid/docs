...
<Tabs>
  <TabItem value="crear" label="Creación de instantáneas" default>
    ...
    - Mantén las instantáneas para hitos importantes, pero elimina las viejas para ahorrar espacio de almacenamiento.
  ...
  <TabItem value="gestionar" label="Gestión de instantáneas">
    ...
    **Eliminar instantánea**: Esto simplemente elimina el archivo de superposición de la instantánea sin afectar tu %%VM|vm%%. Tu %%VM|vm%% sigue usando el archivo de disco original y cualquier cambio hecho después de la instantánea se perderá.
  ...
  <TabItem value="revert" label="Revirtiendo a instantáneas">
    ...
    Revertir a una instantánea elimina permanentemente cualquier cambio hecho después de que se creó esa instantánea. Asegúrate de que realmente deseas perder esos cambios antes de revertir.
