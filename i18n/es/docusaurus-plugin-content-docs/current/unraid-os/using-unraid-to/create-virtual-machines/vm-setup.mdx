...
<details>
  ...
  **Tipo de BIOS:**
  ...
  :::note
  El tipo de BIOS solo se puede configurar al crear un nuevo %%VM|vm%%.
  :::
...
<details>
  ...
  :::tip
  Si esto ocurre con frecuencia, verifica el orden de arranque de tu VM y asegúrate de que el %%vDisk|vdisk%% o ISO correcto esté configurado como el dispositivo de arranque principal en los ajustes de la VM.
  :::
</details>
...
<details>
  ...
  :::note
  Para explicaciones detalladas de los grupos %%IOMMU|iommu%%, te recomendamos consultar el [blog de Alex Williamson](http://vfio.blogspot.com/2014/08/iommu-groups-inside-and-out.html).
  :::
</details>
