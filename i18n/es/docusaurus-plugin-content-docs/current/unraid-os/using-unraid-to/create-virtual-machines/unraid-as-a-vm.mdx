...
- Necesitas una clave de licencia válida y separada para el %%VM|vm%%.
...
<details>
  <summary><strong>2. Configurar el VM en el host</strong> - Haz clic para expandir/contraer</summary>
...
<details>
  <summary><strong>3. Crear e iniciar el VM</strong> - Haz clic para expandir/contraer</summary>
...
<details>
  <summary><strong>4. Configurar el VM</strong> - Haz clic para expandir/contraer</summary>
...
7. Haga clic en **Actualizar** de nuevo. La %%VM|vm%% debería ahora iniciarse normalmente.
