...
<details>
  ...
  Preparar su disco USB es crucial para un proceso de arranque %%VM|vm%% fluido y confiable. Aquí está cómo configurar su entorno %%VM|vm%% con un dispositivo de arranque único y correctamente configurado.
...
<details>
  ...
  :::importante
  La unidad USB de %%VM|vm%% debe ser de un fabricante diferente al de la unidad de arranque del host. Si coinciden, la unidad de %%VM|vm%% no será visible.
  :::
</details>
...
<details>
  <summary><strong>4. Configurar la VM</strong> - Haga clic para expandir/colapsar</summary>
