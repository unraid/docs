...
Antes de personalizar un contenedor Docker en Unraid, es útil entender las opciones básicas de configuración. Cada [plantilla de contenedor](/community-applications/) proporciona una interfaz fácil de usar para configurar la red, el almacenamiento y las variables de entorno, permitiéndote adaptar el comportamiento del contenedor a tus necesidades sin necesidad de usar herramientas de línea de comandos complejas.
