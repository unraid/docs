...
<Tabs>
  ...
  <TabItem value="volumen-mapas" label="Mapeos de Volumen">
    <DockerVolumeMappings />
  </TabItem>

  <TabItem value="puerto-mapas" label="Mapeos de Puerto">
    <DockerPortMappings />
  </TabItem>

  <TabItem value="variables-del-entorno" label="Variables de entorno">
...
- Revise la documentación de cada contenedor para entender los requisitos específicos de inicio.
...
| **Registros**       | Muestra la salida del registro del contenedor para la resolución de problemas.                      |
...
| **Project Page**    | Abre la página del proyecto del contenedor para la documentación y soporte.                         |
| **Soporte**         | Proporciona acceso a los recursos de soporte y ayuda para el contenedor.                            |
