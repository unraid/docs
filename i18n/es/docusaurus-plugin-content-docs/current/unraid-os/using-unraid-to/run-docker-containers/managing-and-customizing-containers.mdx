...
| **Registros**           | Muestra la salida de los registros del contenedor para solucionar problemas.                                                             |
...
| **Eliminar**            | Elimina el contenedor. Puede optar por eliminar solo el contenedor o también su imagen.                                                  |
| **Página del proyecto** | Abre la página de proyecto del contenedor para documentación y soporte.                                                                  |
