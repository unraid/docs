...
Para una guía completa sobre cómo instalar y usar el plugin Aplicaciones de la Comunidad, incluyendo características avanzadas y soluciones de problemas, consulta [Aplicaciones de la Comunidad](/community-applications/).
