...
Almacene los datos de la aplicación (configuraciones, bibliotecas, etc.) fuera del contenedor, típicamente en el `appdata` %%user share|user-share%%. Este [enfoque de administración de shares](../../../manage-storage/shares.mdx) mantiene sus datos seguros durante las actualizaciones o reinstalaciones.
