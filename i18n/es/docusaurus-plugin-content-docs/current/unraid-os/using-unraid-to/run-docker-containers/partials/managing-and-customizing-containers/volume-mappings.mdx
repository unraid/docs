...
:::tip[Best práctica]
Almacene los datos de la aplicación (configuraciones, bibliotecas, etc.) fuera del contenedor, típicamente en el `appdata` %%user share|user-share%%. Este enfoque de [gestión de acciones](../../../manage-storage/shares.mdx) mantiene sus datos seguros durante actualizaciones o reinstalaciones.
:::
