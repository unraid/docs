...
Busque en esta página `-rc.2` para ver qué ha cambiado desde el último RC.
...
Para instrucciones paso a paso, vea [Actualización de Unraid](../../unraid-os/system-administration/maintain-and-update/upgrading-unraid.mdx). ¿Preguntas sobre su [licencia](../../unraid-os/troubleshooting/licensing-faq.mdx#pre-release-policy)?
...
- Mejora: No se compartirá un directorio `lost+found` de nivel superior \[-rc.2]
- Corrección: En smb.conf, configure `smb3 directory leases = no` para evitar problemas con la versión actual de Samba \[-rc.2]
- Corrección: Restaurar los comentarios en archivos `/etc/modprobe.d/*.conf` predeterminados \[-rc.2]
- Corrección: Windows no puede crear una carpeta nueva para compartir con un pool ZFS primario y disco de arreglo secundario ext4 \[-rc.2]
- Corrección: Los nuevos dispositivos añadidos a un arreglo existente con paridad válida deberían ser reparticionados \[-rc.2]
- Corrección: No apague los dispositivos para los cuales la autoprueba SMART está en progreso \[-rc.2]
- Corrección: Nuevo dispositivo de arreglo no disponible para compartir hasta que el arreglo se reinicie \[-rc.2]
...
- Corrección: Cambiar los valores predeterminados de la VM de Windows 11 \[-rc.2]
- Corrección: Aberración de visualización al crear un snapshot de VM \[-rc.2]
...
- Mejora: Mostrar RAM y velocidad de red en unidades legibles para humanos \[-rc.2]
- Corrección: En _**Configuración → Configuración de Pantalla → Tamaño de Fuente**_, elimine opciones extremas que rompen el WebGUI \[-rc.2]
- Corrección: Aberración de visualización en _**Configuración → Programador**_ cuando se establece en Horario \[-rc.2]
- Corrección: Los elementos de menú desplegable deshabilitados no se mostraban en color deshabilitado en Firefox \[-rc.2]
...
- Corrección: Mayor anonimización de diagnostics.zip \[-rc.2]
- Mejora: Proteger el WebGUI de errores PHP fatales \[-rc.2]
- Mejora: Ajustar el registro durante las instalaciones de complementos \[-rc.2]
- Corrección: Pérdida de memoria de emhttpd \[-rc.2]

### Núcleo de Linux

- versión 6.12.53-Unraid \[-rc.2]
...
- at-spi2-core: versión 2.58.1 \[-rc.2]
- bash: versión 5.3.003
- bind: versión 9.20.13
- btrfs-progs: versión 6.17
- ca-certificates: versión 20251003 \[-rc.2]
...
- gdbm: versión 1.26
- gdk-pixbuf2: versión 2.44.3 \[-rc.2]
- git: versión 2.51.0
- glib2: versión 2.86.0
- glibc: versión 2.42 (compilación 2)
- gnutls: versión 3.8.10
- grub: versión 2.12
- gtk+3: versión 3.24.51 \[-rc.2]
- harfbuzz: versión 12.1.0 \[-rc.2]
...
- kbd: versión 2.9.0
- kernel-firmware: versión 20251011\_919daee \[-rc.2]
- krb5: versión 1.22.1
- less: versión 679
...
- libdrm: versión 2.4.126 \[-rc.2]
- libffi: versión 3.5.2
- libgpg-error: versión 1.56 \[-rc.2]
...
- mcelog: versión 207 \[-rc.2]
- mesa: versión 25.2.4 \[-rc.2]
- nano: versión 8.6
- ncurses: versión 6.5\_20250816
- nettle: versión 3.10.2
- nghttp2: versión 1.67.1
- nghttp3: versión 1.12.0
- noto-fonts-ttf: versión 2025.10.01 \[-rc.2]
- nvme-cli: versión 2.15
- openssh: versión 10.2p1 \[-rc.2]
- openssl: versión 3.5.4 \[-rc.2]
...
- spirv-llvm-translator: versión 21.1.1 \[-rc.2]
...
- wireless-regdb: versión 2025.10.07 \[-rc.2]
- xdpyinfo: versión 1.4.0
- xdriinfo: versión 1.0.8
- xfsprogs: versión 6.16.0
- xkeyboard-config: versión 2.46 \[-rc.2]
