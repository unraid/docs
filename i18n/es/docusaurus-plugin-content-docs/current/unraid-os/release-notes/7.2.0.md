...
Ahora puedes expandir tus pools RAIDZ1/2/3 de un solo vdev, una unidad a la vez. Para instrucciones detalladas, consulta [expansión de RAIDZ](/es/unraid-os/using-unraid-to/manage-storage/cache-pools#raidz-expansion).
