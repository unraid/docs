...
- CONFIG_X86_SGX: Extensiones de Guardia de Software (SGX)
- CONFIG_X86_SGX_KVM: Virtualización de Extensiones de Guardia de Software (SGX)
- CONFIG_CRYPTO_ZSTD: Algoritmo de compresión Zstd
