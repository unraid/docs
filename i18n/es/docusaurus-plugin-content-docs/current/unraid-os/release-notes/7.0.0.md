...
Los compartidos ahora pueden configurarse con agrupaciones tanto para almacenamiento primario como secundario, y el mover moverá
archivos entre esas agrupaciones.
Como resultado de este cambio, el número máximo de agrupaciones admitidas ahora es 34 (anteriormente 35).
