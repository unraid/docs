...
- Un pequeño cambio necesario para invocar nuestro script 'update_services' cada vez que un túnel de WireGuard
...
- notificaciones por correo electrónico: agregue la línea en /etc/php.ini: 'mail.mixed_lf_and_crlf=On' para solucionar el cambio
