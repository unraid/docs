...
Instale DiskSpeed desde [Community Applications](/community-applications/) (***Pestaña de Apps***) buscando "DiskSpeed", o visite el [repositorio de GitHub](https://github.com/jbartlett777/DiskSpeed) para instrucciones de instalación manual.
...
Una lectura baja de memoria "disponible" no necesariamente indica un problema—Linux almacena datos en caché de forma agresiva para mejorar el rendimiento.
...
## Ver uso de fdisk {/* #file-transfer-operations */}
