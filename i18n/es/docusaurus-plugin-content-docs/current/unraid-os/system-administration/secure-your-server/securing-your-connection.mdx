...
| **Usar SSL/TLS**        | Set in ***Settings → Management Access***. Controls whether %%SSL\|ssl%% is enabled.          |
...
| ----------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------ |
| **Autofirmado**   | Para acceso solo local cuando no necesitas un certificado de confianza.                                                                        | Easy to set up, but browsers show warnings. Traffic is encrypted once the warning is accepted.               |
