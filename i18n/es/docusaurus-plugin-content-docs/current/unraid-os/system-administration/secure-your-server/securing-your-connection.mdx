...
| ----------------------- | ------------------------------------------------------------------------------------------- |
| **Nombre del servidor** | Set in ***Settings → Identification***. Default is `tower`.                                 |
| **TLD local**           | Set in ***Settings → Management Access***. Default is `local`.                              |
| **Usar SSL/TLS**        | Establecido en ***Ajustes → Acceso de Gestión***. Controla si %%SSL\|ssl%% está habilitado. |
| **Puerto HTTP**         | Set in ***Settings → Management Access***. Default is `80`.                                 |
| **Puerto HTTPS**        | Set in ***Settings → Management Access***. Default is `443`.                                |
...
| **Myunraid.net**  | Para acceso seguro local y remoto, especialmente con Unraid Connect o si deseas un certificado de confianza.                                   | Trusted by browsers, no warnings. Enables secure remote access via Unraid Connect.                                        |
