...
| ----------------------- | --------------------------------------------------------------------------------------------- |
| **Nombre del servidor** | Configuración en ***Configuración → Identificación***. El valor predeterminado es `tower`.    |
| **TLD local**           | Configuración en ***Configuración → Acceso de Gestión***. El valor predeterminado es `local`. |
| **Usar SSL/TLS**        | Establecido en ***Ajustes → Acceso de Gestión***. Controla si %%SSL\|ssl%% está habilitado.   |
...
| ----------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------- |
| **Autofirmado**   | Para acceso solo local cuando no necesitas un certificado de confianza.                                                                        | Fácil de configurar, pero los navegadores muestran advertencias. El tráfico está cifrado una vez aceptada la advertencia. |
