...
- **Embudo**: Publica el sitio web del contenedor en internet público a través de una URL HTTPS única. Cualquiera con el enlace puede acceder, incluso si no están en tu Tailnet. Usa esto con precaución, ya que expone tu servicio a internet en general.
  :::
...
- Para la mayoría de los usuarios, la configuración predeterminada proporciona acceso seguro y confiable. Hay opciones avanzadas disponibles para necesidades especializadas de redes.
  :::
