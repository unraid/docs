...
:::tip
Considera guardar una captura de pantalla de tus [asignaciones de disco](../../getting-started/set-up-unraid/configure-your-array.mdx#assign-parity-and-data-disks) después de cualquier cambio de hardware. Esto asegura la colocación correcta de los discos si necesitas restaurar desde tu copia de seguridad.
:::
