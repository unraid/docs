...
Para más detalles, consulte [la documentación de Microsoft sobre el acceso invitado de SMB](https://learn.microsoft.com/en-us/windows-server/storage/file-server/enable-insecure-guest-logons-smb2-and-smb3).
:::
