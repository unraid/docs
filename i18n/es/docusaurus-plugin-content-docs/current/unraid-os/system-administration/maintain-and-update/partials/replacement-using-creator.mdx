...
1. Descargue la herramienta [USB Flash Creator](https://unraid.net/download) para Windows o macOS.
2. Inserte su nueva unidad USB (medio de arranque) en su computadora.
...
4. Elija su nueva unidad USB como destino y haga clic en **Escribir**.
5. Apague su servidor, cambie el dispositivo de arranque antiguo por el nuevo y encienda el servidor.
...
Si ves un error de "el archivo de clave no es válido", tu clave podría estar en la lista negra o no ser la última clave válida. [Contacta al soporte de Unraid](https://unraid.net/support) para asistencia.
