...
Primero, siga nuestra [guía de inicio](/go/getting-started/) para configurar un servidor Unraid.
...
- Consulte nuestro [Licensing FAQ](/go/faq-licensing/) para más información
