...
:::important
Las copias de seguridad no incluyen los archivos `config/shadow` o `config/smbpasswd`. Las cuentas de usuario se conservan, pero no las contraseñas. Deberá restablecer todas las contraseñas de los usuarios, incluida la contraseña de root, después de la restauración. Las claves de %%WireGuard|wireguard%% también están excluidas.
:::
