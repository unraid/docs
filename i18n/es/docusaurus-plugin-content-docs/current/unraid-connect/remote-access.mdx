...
| Característica                         | Dynamic remote access                  | Static remote access                  |
| -------------------------------------- | -------------------------------------- | ------------------------------------- |
| %%WebGUI\|web-gui%% abierto a internet | Only when enabled                      | Always                                |
| Attack surface                         | Minimized                              | Maximized                             |
| Automation                             | Apertura/cierre automático vía Connect | Configuración manual, siempre abierto |
