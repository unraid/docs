...
Tout d’abord, suivez notre [Guide de démarrage](/go/getting-started/) pour configurer un serveur Unraid.
...
- Consultez notre [FAQ sur les licences](/go/faq-licensing/) pour plus d'informations
