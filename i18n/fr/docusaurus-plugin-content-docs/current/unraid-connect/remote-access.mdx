...
| Fonctionnalité                        | Dynamic remote access                       | Static remote access                    |
| ------------------------------------- | ------------------------------------------- | --------------------------------------- |
| %%WebGUI\|web-gui%% ouvert à Internet | Only when enabled                           | Always                                  |
| Attack surface                        | Minimized                                   | Maximized                               |
| Automation                            | Ouverture/fermeture automatique via Connect | Configuration manuelle, toujours ouvert |
