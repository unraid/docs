...
- Utilisez 4 à 6 éléments maximum dans une liste non ordonnée pour faciliter la lecture et la mémorisation. Les listes plus longues peuvent être mieux structurées sous forme de tableau.
  :::
...
- Présentez le tableau avec une phrase qui explique son objectif et son contenu.
  :::
