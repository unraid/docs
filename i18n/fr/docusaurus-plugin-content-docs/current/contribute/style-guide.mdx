...
- **Listes non ordonnées** (à puce) : Utilisez-les pour regrouper des éléments connexes sans impliquer d'ordre.
  *Exemple :* "Liste des outils courants d'Unraid OS."

- **Listes ordonnées** (numérotées) : Utilisez-les pour montrer une séquence ou procédure requise.
...
- Épélez toujours les acronymes ou sigles non courants la première fois qu'ils sont utilisés, suivis de l'abréviation entre parenthèses.
  *Exemple :* Disque de Machine Virtuelle (VMDK)
