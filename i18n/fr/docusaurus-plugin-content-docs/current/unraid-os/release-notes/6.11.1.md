...
- CONFIG_X86_SGX : Extensions de Protection Logicielle (SGX)
- CONFIG_X86_SGX_KVM : Virtualisation des Extensions de Protection Logicielle (SGX)
- CONFIG_CRYPTO_ZSTD : Algorithme de compression Zstd
