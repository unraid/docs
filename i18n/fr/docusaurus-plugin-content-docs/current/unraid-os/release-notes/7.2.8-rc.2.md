...
Cette version candidate met à jour le noyau Linux vers 6.12.98-Unraid, avec des vérifications de compatibilité correspondantes des modules de stockage réussies par rapport à Unraid OS 7.2.8-rc.1.
...
- Aucun nouveau problème connu spécifique à cette version n'est identifié dans le contexte source. Reportez-vous aux notes de version précédentes pertinentes.

## Notes

- Les modules ZFS couplés au noyau passent les vérifications de compatibilité pour 6.12.98-Unraid.

## Rétrogradation

- Aucun blocage de retour arrière spécifique à cette version n'est identifié dans le contexte source.
- Consultez les notes de version d'Unraid OS 7.2.8-rc.1 avant de revenir en arrière.

## Modifications par rapport à Unraid OS 7.2.8-rc.1

### Noyau Linux

- Noyau Linux : mise à jour vers 6.12.98-Unraid.
