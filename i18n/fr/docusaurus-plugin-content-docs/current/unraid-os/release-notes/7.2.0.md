...
- version 6.12.54-Unraid
  ...
  - Ajout de la prise en charge de l'eMMC :
    - CONFIG\_MMC : Support carte MMC/SD/SDIO
    - CONFIG\_MMC\_BLOCK : Pilote de périphérique bloc MMC
    - CONFIG\_MMC\_SDHCI : Support Interface de Contrôleur Hôte Digital Sécurisé
    - CONFIG\_MMC\_SDHCI\_PCI : Support SDHCI sur bus PCI
    - CONFIG\_MMC\_SDHCI\_ACPI : Support SDHCI pour contrôleurs SDHCI énumérés par ACPI
    - CONFIG\_MMC\_SDHCI\_PLTFM : SDHCI plate-forme et assistant pilote OF
