...
Vous pouvez maintenant étendre vos pools RAIDZ1/2/3 à un seul VDEV, un disque à la fois. Pour des instructions détaillées, voir [extension RAIDZ](/fr/unraid-os/using-unraid-to/manage-storage/cache-pools#raidz-expansion).
