...
Les partages peuvent désormais être configurés avec des pools pour le stockage primaire et secondaire, et le déménageur déplacera les fichiers entre ces pools.
En conséquence de ce changement, le nombre maximum de pools pris en charge est maintenant de 34 (contre 35 précédemment).
