...
- version 5.19.17
- correctif : bogues supplémentaires NVMe BOGUS_NID pour les appareils non conformes signalés par les utilisateurs.
- prise en charge sonore :
  - CONFIG_SON : prise en charge des cartes son
  - CONFIG_SND : Architecture sonore avancée de Linux
  - CONFIG_SND_OSSEMUL : Activer l'émulation OSS
  - CONFIG_SND_PCM_OSS : API OSS PCM (audio numérique)
  - CONFIG_SND_HRTIMER : Support du backend HR-timer
  - CONFIG_SND_SUPPORT_OLD_API : Prise en charge de l'ancienne API ALSA
  - CONFIG_SND_PROC_FS : Prise en charge de Sound Proc FS
- CONFIG_IPV6 : Le protocole IPv6 (passé de module à intégré)
...
- firmware du noyau : version 20221017_48407ff
- less : version 608
