...
Unraid OS 7.2.8-rc.1 est une version de maintenance candidate à la publication axée sur des mises à jour de paquets de base liées à la sécurité, le noyau Linux 6.12.96-Unraid, Unraid API 4.36.1, Docker, ZFS et une couverture étendue du micrologiciel sans fil Intel.
...
- Aucun nouveau problème connu spécifique à cette version n’a été identifié. Consultez les notes de version d’Unraid OS 7.2.7 pour les problèmes connus antérieurs.

## Notes

- Les modules ZFS liés au noyau ont passé les vérifications de compatibilité pour 6.12.96-Unraid.

## Rétrogradation

- Aucun nouvel avertissement de restauration. Consultez les notes de restauration pour Unraid OS 7.2.7 avant de rétrograder.
...
- Noyau Linux : mise à jour vers 6.12.96-Unraid.
