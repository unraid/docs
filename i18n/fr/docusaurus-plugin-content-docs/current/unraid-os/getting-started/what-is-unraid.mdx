...
Unraid s'installe sur une clé USB et démarre à partir de celle-ci, se chargeant dans un système de fichiers RAM racine. Il utilise un noyau Linux moderne avec des pilotes matériels mis à jour, lui permettant de fonctionner sur presque tous les systèmes 64 bits x86\_64 tout en gardant une empreinte mémoire minimale. Toutes les données de configuration pour le système d'exploitation sont stockées sur la clé USB et se chargent en même temps que le système d'exploitation.
