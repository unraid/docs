...
<details>
  ...
  Si vous souhaitez plus de contrôle ou avez besoin de personnalisation avancée, vous pouvez configurer les paramètres de veille et de WoL via la ligne de commande. Cette méthode est recommandée pour les utilisateurs avancés.
  ...
  Les paramètres WoL configurés manuellement **ne sont pas persistants** après un redémarrage par défaut. Pour les rendre permanents :
