...
Installez DiskSpeed depuis les [Applications Communautaires](/community-applications/) (***onglet Apps***) en recherchant "DiskSpeed", ou visitez le [référentiel GitHub](https://github.com/jbartlett777/DiskSpeed) pour des instructions d'installation manuelles.
...
Un faible niveau de mémoire « disponible » n’indique pas nécessairement un problème — Linux met agressivement les données en cache pour améliorer les performances.
...
## Voir l'utilisation de fdisk {/* #file-transfer-operations */}
