...
<details>
  ...
  Installez DiskSpeed à partir des [Applications Communautaires](../../using-unraid-to/run-docker-containers/community-applications.mdx) (***onglet Applications***) en recherchant "DiskSpeed", ou visitez le [répertoire GitHub](https://github.com/jbartlett777/DiskSpeed) pour les instructions d'installation manuelle.
</details>
...
<details>
  ...
  **Note de sécurité :** Ne passez pas les mots de passe en ligne de commande. Utilisez une
  invite interactive ou un fichier de crédentiels avec des permissions strictes à la place.
