...
5. **Mettre à jour Unraid OS** en utilisant la page ***Outils → Mise à jour OS***.
...
<details>
  ...
  Si vous rencontrez des erreurs comme *"les couches du manifeste ne correspondent pas à la configuration de l'image,"* vous devrez peut-être reconstruire votre fichier d'image Docker. Voici comment :
...
<details>
  ...
  3. Accédez à ***Paramètres → Gestionnaire de VM*** (en **Vue avancée**) et définissez le pont par défaut sur `br0`.
</details>
