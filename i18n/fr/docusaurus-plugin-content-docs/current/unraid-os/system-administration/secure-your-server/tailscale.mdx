...
11. **Mettez à jour le plugin Unraid %%Tailscale|tailscale%%:** Lorsqu'une nouvelle version est disponible, mettez à jour le plugin via l'onglet Applications Unraid comme n'importe quel autre plugin. Vous pouvez toujours consulter les dernières modifications dans le [changelog %%Tailscale|tailscale%%](https://tailscale.com/changelog).
