...
- Les journaux enregistrés à l'aide de cette méthode ne sont pas inclus dans les diagnostics standard. Attachez-les séparément si vous avez besoin d'assistance.
  :::
