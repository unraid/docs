...
Si les deux prolongations supplémentaires n'ont pas été utilisées et que cette option n'apparaît pas pour vous, ou si elle ne fonctionne pas pour une raison quelconque, veuillez nous envoyer le GUID du lecteur flash depuis **Outils > Enregistrement** à [contact@unraid.net](mailto:contact@unraid.net) ou via notre portail d'assistance à [support.unraid.net](https://support.unraid.net/support/home) et nous serons heureux de vous aider.
