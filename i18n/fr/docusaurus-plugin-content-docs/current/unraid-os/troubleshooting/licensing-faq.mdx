...
### Possède-je ma licence logicielle ?
...
Les codes d'activation sont à usage unique pour générer votre fichier de clé de licence Unraid.
...
### [Je suis un revendeur/FEO besoin d'acheter une licence pour le compte de mon client. Que dois-je faire ?
...
<a id="upgrade-license"></a>

### Comment mettre à niveau ma licence Unraid ?
...
<a id="manual-keyfile-install"></a>

### Comment installer manuellement mon fichier de clé de licence sur mon périphérique USB ?
...
<a id="registration-type"></a>

### Comment déterminer mon type d'enregistrement ?
...
### Que se passe-t-il si je n'étends pas ma licence Starter ou Unleashed ?
...
<a id="pre-release-policy"></a>

### Qu'en est-il des pré-versions (version Beta/RC) ?
...
<a id="unlimited-storage"></a>

### Que signifie "illimité" pour les périphériques de stockage connectés ?
...
Sauvegardez régulièrement votre périphérique USB en utilisant [Unraid Connect](../../unraid-connect/overview-and-setup.mdx) pour simplifier la récupération et éviter la perte de données.

:::

<a id="guid-error"></a>

### Que devrais-je faire si je reçois une erreur d'enregistrement de mon périphérique flash : '####-####-####-#############' est déjà enregistré à un autre utilisateur ?
...
<a id="trial-license"></a>

### Comment fonctionnent les essais Unraid ?
...
<a id="trial-key-transfer"></a>

### Puis-je transférer ma clé d'essai vers un nouveau périphérique flash ?
