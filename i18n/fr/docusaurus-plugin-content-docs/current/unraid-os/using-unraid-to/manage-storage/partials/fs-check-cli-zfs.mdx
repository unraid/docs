...
:::info
%%ZFS|zfs%% ne nécessite pas et ne prend pas en charge les utilitaires `fsck` traditionnels. La nature transactionnelle de %%ZFS|zfs%% signifie qu'il passe atomiquement d'un état cohérent à un autre, ce qui fait du "scrubbing" la méthode préférée pour la vérification de l'intégrité.
:::
