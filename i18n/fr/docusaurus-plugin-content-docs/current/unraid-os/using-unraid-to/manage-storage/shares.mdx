...
Vous pouvez accéder et gérer les %%partages utilisateurs|user-share%% depuis l'onglet **Partages** dans le **WebGUI**. Cette interface vous permet de:
...
1. **Paramètres du Mover (si nécessaire)**

2. **Terminer le processus :** Cliquez sur **Ajouter un partage** pour terminer la configuration de votre nouveau partage.
