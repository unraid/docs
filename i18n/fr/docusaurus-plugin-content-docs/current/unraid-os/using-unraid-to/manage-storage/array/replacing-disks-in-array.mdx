...
9. Vérifiez la santé du disque en exécutant un [test étendu SMART](/unraid-os/system-administration/advanced-tools/command-line-interface#smartctl) et en prenant note de toute icône d'avertissement sur le tableau de bord.
