...
| ----------------------------- | ---------------------------------------- | ---------------------- | -------------------------------- | ------------------------- | ------------------------------------------------------------------------ |
| Lire/Modifier/Écrire          | 20–40 Mo/s                               | Faible                 | Seulement parité et disque cible | Yes                       | La plupart des charges de travail, économie d'énergie, petites écritures |
| Écriture Turbo (Reconstruire) | 40–120 Mo/s                              | Élevée                 | Tous les disques                 | Yes                       | Large file transfers, array rebuilds, %%parity checks\|parity-check%%    |
...
- Les plugins de la communauté (cherchez "Turbo Write" dans l'onglet Apps) peuvent offrir des options d'automatisation ou de planification améliorées. :::
