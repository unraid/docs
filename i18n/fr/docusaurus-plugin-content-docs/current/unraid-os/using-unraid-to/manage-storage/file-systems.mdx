...
Bien que la %%parité|parity%% aide à récupérer un lecteur défaillant, elle ne peut pas résoudre les problèmes de système de fichiers. Si le système de fichiers est corrompu, la %%parité|parity%% ne fera que répliquer cette corruption sur le nouveau lecteur.
