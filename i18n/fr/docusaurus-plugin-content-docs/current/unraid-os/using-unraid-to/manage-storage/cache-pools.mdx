...
- **Pools RAIDZ1/2/3 simples-vdev :** Un pool avec un groupe de disques en configuration RAIDZ. Peut être étendu un disque à la fois. Voir [Extension RAIDZ](#extension-raidz) ci-dessous.
