...
Ce guide s’applique aux versions macOS Ventura (13.x), Sonoma (14.x) et Sequoia (15.x). Certaines fonctionnalités, telles que les améliorations de %%SMB|samba%% et le support Time Machine via %%SMB|samba%%, nécessitent des versions de macOS qui prennent en charge ces protocoles.

Pour obtenir les meilleurs résultats, maintenez votre Mac à jour avec la dernière version de macOS compatible avec votre matériel.
:::attention[Considérations pour macOS Sequoia (15.x)]
