...
Pour une liste des systèmes d'exploitation testés avec Unraid, voir la page [VM Setup](./vm-setup.mdx).
...
Dans le %%WebGUI|web-gui%%, cliquez sur **Info** dans le menu supérieur.
...
- L’utilisation de la %%Cache|cache%% pour le partage `isos` est optionnelle.
