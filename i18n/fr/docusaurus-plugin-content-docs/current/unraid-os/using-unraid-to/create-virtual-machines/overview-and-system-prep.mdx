...
Votre BIOS de carte mère doit activer la virtualisation assistée par matériel et le support %%IOMMU|iommu%%. Recherchez les paramètres étiquetés « %%Intel VT-x|intel-vt-x%% », « Intel VT-d », « %%AMD-V|amd-v%% » ou « AMD-Vi ».
