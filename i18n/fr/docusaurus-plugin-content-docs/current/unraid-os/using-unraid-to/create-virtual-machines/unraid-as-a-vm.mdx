...
- Vous avez besoin d'une clé de licence valide et distincte pour le %%VM|vm%%.
...
<details>
  <summary><strong>2. Configurer le VM sur l'hôte</strong> - Cliquez pour développer/réduire</summary>
...
<details>
  <summary><strong>3. Créer et démarrer le VM</strong> - Cliquez pour développer/réduire</summary>
...
<details>
  <summary><strong>4. Configurer le VM</strong> - Cliquez pour développer/réduire</summary>
...
7. Cliquez sur **Mettre à jour** à nouveau. La %%VM|vm%% devrait maintenant démarrer normalement.
