...
12. Assignez des **Périphériques USB** selon les besoins.
    ...
    - Le périphérique de démarrage Unraid (USB) n'est pas disponible pour l'affectation.
...
2. **Émulation** : Utilise un modèle CPU générique, réduisant les problèmes de compatibilité mais limitant les performances.
...
- Pour plus d'informations, consultez les étapes de liaison des périphériques et de passthrough sur cette page.
