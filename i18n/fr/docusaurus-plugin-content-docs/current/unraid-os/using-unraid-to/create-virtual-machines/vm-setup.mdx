...
<details>
  ...
  **Type de BIOS :**
  ...
  :::note
  Le type de BIOS ne peut être défini que lors de la création d'une nouvelle %%VM|vm%%.
  :::
...
<details>
  ...
  :::note
  Vous ne pouvez pas réduire un %%vDisk|vdisk%% depuis l'interface GUI d'Unraid; seule l'expansion est prise en charge.
  :::
  ...
  :::tip
  Sauvegardez toujours votre %%VM|vm%% avant de faire des modifications au disque.
  :::
</details>
...
<details>
  ...
  :::note
  Pour des explications détaillées sur les groupes %%IOMMU|iommu%%, nous recommandons de consulter [le blog d'Alex Williamson](http://vfio.blogspot.com/2014/08/iommu-groups-inside-and-out.html).
  :::
</details>
