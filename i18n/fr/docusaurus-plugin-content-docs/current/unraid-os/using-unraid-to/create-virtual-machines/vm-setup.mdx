...
Consultez la section [fonctionnalités du gestionnaire %%VM|vm%%](#new-in-unraid-7x-vm-manager) pour plus de détails.
:::
...
- Décidez si vous utiliserez %%GPU passthrough|gpu-passthrough%% ou %%VNC|vnc-session%% pour les graphiques.
  :::
...
<details>
  <summary><strong>Plus de fonctionnalités avancées</strong></summary>
...
- Certains appareils USB peuvent ne pas fonctionner de manière fiable avec le passthrough - testez et consultez [les forums Unraid](https://forums.unraid.net/) pour des conseils spécifiques aux appareils.
  :::
...
- **Flexibilité :** Transformez votre serveur Unraid en station de travail multi-usage.
  :::
