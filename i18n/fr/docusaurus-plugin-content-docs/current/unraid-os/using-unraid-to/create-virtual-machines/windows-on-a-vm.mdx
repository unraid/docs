...
L’indexation de Windows Search analyse en continu le stockage de votre %%virtual machine|vm%% afin de cataloguer les fichiers pour obtenir des résultats de recherche plus rapides. Cependant, sur une %%virtual machine|vm%%, cela peut entraîner des E/S disque inutiles, ralentir les performances et accroître l’usure de votre stockage physique, en particulier les SSD de votre [cache pool](../manage-storage/cache-pools.mdx).
