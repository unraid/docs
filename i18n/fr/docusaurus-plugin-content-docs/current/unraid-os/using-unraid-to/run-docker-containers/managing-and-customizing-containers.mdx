...
| **Redémarrer**     | Redémarre le conteneur, appliquant tout changement de configuration.                                                                                 |
...
| **Supprimer**      | Supprime le conteneur. Vous pouvez choisir de retirer seulement le conteneur ou également supprimer son image.                                       |
| **Page du projet** | Ouvre la page de projet du conteneur pour la documentation et le support.                                                                            |
| **Support**        | Fournit l'accès aux ressources de support et d'aide pour le conteneur.                                                                               |
