...
:::tip[Best pratique]
Stockez les données d'application (paramètres, bibliothèques, etc.) à l'extérieur du conteneur, généralement dans le partage utilisateur appdata %%user share|user-share%%. Cette [gestion des partages](../../../manage-storage/shares.mdx) permet de garder vos données en sécurité pendant les mises à jour ou les réinstallations.
:::
