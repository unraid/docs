...
![](/docs/legacy/Docker_register_mirrors.png)

随后单击第三个按钮 "EDIT SCRIPT"（编辑脚本）：
![](/docs/legacy/Edit_Script.png)
...
![](/docs/legacy/Run_in_background.png)
