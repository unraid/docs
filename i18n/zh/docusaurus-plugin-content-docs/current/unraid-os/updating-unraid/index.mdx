...
更新 Unraid OS 可确保您获得最新功能、安全更新和硬件支持。本页概述了标准更新流程，以及故障排除提示和手动更新选项。
...
## 标准更新流程 {/* #standard-update-process */}
...
只有当您无法访问 %%WebGUI|web-gui%% 或降级选项不可用时，才需要手动降级。在继续之前，备份您的 USB 闪存设备非常重要。更多详细信息，请参阅 [备份您的闪存设备](../system-administration/maintain-and-update/changing-the-flash-device.mdx#backing-up-your-flash-device) 。
