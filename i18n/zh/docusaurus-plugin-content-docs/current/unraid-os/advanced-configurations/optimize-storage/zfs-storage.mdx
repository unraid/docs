...
- **用更大的磁盘替换驱动:** 一次替换每个 vdev 驱动为更大的磁盘。请参阅 [驱动替换](/zh/unraid-os/using-unraid-to/manage-storage/array/replacing-disks-in-array#replacing-faileddisabled-disks) 以获取详尽步骤。在所有驱动替换并且池解析之后，vdev 的容量将增加。
