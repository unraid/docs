...
- **对于混合或扩展池：** 如果您想使用不同的驱动器大小或轻松添加或删除设备，%%BTRFS|btrfs%% 是理想的选择。详情请参见 [BTRFS 池](/zh/unraid-os/using-unraid-to/manage-storage/cache-pools#btrfs-pools) 关于向 %%BTRFS|btrfs%% 池添加磁盘。
