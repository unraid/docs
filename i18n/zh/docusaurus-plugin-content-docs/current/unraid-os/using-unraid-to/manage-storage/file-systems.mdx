...
有关添加现有驱动器的更多详细信息，请参阅[发行说明](../../release-notes/7.2.0.mdx#ext234-ntfs-and-exfat-support)。
...
1. 将所有数据从驱动中移到其他位置（另一个 %%array|阵列%% 驱动、%%cache pool|缓存池%% 或外部备份）。使用以下方法之一：
   ...
   **或通过命令行（仅适用于 Unraid 7.0 和 7.1）：**
   ...
   - 通过['mover'将数据移动到其他阵列驱动器](../../release-notes/7.0.0.mdx#using-mover-to-empty-an-array-disk)
