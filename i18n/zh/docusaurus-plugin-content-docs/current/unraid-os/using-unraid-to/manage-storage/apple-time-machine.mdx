...
2. 配置以下设置:
   ...
   | **最小可用空间**                  | Set to **1** (1 KB) for best results. This prevents Time Machine from failing when disks approach capacity.                                                                                                    |
   ...
   | **安全设置**                    | Configure %%SMB\|samba%% security parameters as desired.                                                                                                                                                       |
