...
为了获得最佳效果，请确保您的 Mac 更新到与您的硬件兼容的 macOS 最新版本。
:::注意[macOS Sequoia (15.x) 注意事项]
有用户报告称在 macOS Sequoia 上使用 Time Machine 和网络共享时出现间歇性问题。如果您遇到备份失败，建议考虑使用 [Time Machine Docker 容器](https://unraid.net/community/apps?q=time+machine#r) 作为替代方案。
:::
