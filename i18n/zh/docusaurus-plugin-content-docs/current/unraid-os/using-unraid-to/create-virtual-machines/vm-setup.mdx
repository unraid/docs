...
<details>
  ...
  :::注意
  您无法从 Unraid GUI 缩小 %%vDisk|vdisk%%；仅支持扩展。
  :::
...
<details>
  ...
  :::提示
  如果这种情况经常发生，请检查您的 VM 的启动顺序，并确保在 VM 设置中正确设置 %%vDisk|vdisk%% 或 ISO 作为主启动设备。
  :::
</details>
...
<details>
  ...
  :::注意
  有关详细的 %%IOMMU|iommu%% 组说明，我们建议查看 [Alex Williamson 的博客](http://vfio.blogspot.com/2014/08/iommu-groups-inside-and-out.html)。
  :::
</details>
