...
您可以在 Unraid 虚拟机 (VM) 中直接从物理磁盘运行 Windows 安装。此方法有助于迁移现有的 Windows 系统，而无需将其转换为虚拟磁盘映像。有关详细的操作步骤，请查看 Spaceinvader One 的教程：[如何在 Unraid VMs 中传递硬盘、转换磁盘和测试性能 (YouTube)](https://www.youtube.com/watch?v=QaB9HhpbDAI)。
