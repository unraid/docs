...
<details>
  ...
  - 当前版本的 Unraid 附带的\*\*Memtest86+\*\*可在传统和%%UEFI|uefi%%模式下运行。对于较旧的 Unraid 版本，请从[官方 Memtest 网站](https://www.memtest86.com/)获取与%%UEFI|uefi%%兼容的版本。
...
4. 重新解压 Unraid 发行版 bz\* 文件到闪存设备上，以防止潜在的损坏。
...
7. 测试新的闪存设备并执行干净的 Unraid 安装。这有助于判断服务器硬件是否存在问题。
