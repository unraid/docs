...
在 [社区应用程序](/community-applications/) （***应用程序选项卡***）中搜索 "DiskSpeed" 来安装 DiskSpeed，或者访问 [GitHub 仓库](https://github.com/jbartlett777/DiskSpeed) 以获取手动安装说明。
...
低“可用”内存读数并不一定表明存在问题——Linux 会为了性能积极缓存数据。
...
## 文件传输操作 {#file-transfer-operations}
