...
<details>
  ...
  通过在 **应用 商店** 中搜索 "DiskSpeed" 从 [社区应用](../../using-unraid-to/run-docker-containers/community-applications.mdx) 安装 DiskSpeed，或者访问 [GitHub 代码库](https://github.com/jbartlett777/DiskSpeed) 获取手动安装说明。
</details>
...
<details>
  ...
  :::tip[Understand 输出]
  低 "可用" 内存读数不一定表明存在问题 — Linux 会积极地缓存数据以提高性能。
  :::
</details>
...
<details>
  ...
  **安全提示：** 不要在命令行上传递密码。应改用交互提示或具有严格权限的凭证文件。
