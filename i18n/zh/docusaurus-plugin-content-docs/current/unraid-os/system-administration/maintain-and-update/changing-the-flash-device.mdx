...
### 在没有备份的情况下从失败的闪存设备中恢复 {/* #backing-up-your-flash-device */}
...
7. 如果您已检查**校验有效**，请运行一次纠正性的[校验](../../using-unraid-to/manage-storage/array/array-health-and-maintenance.mdx#parity-checks)，以确认您的配置是否正确。
