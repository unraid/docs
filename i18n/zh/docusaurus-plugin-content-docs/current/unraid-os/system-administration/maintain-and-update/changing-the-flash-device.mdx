...
2022年1月的[论坛公告关于仿冒SanDisk驱动器](https://forums.unraid.net/topic/119052-psa-on-sandisk-usbs/) 确认不推荐使用SanDisk，由于存在仿冒设备和制造变更导致的非唯一GUID，这影响了仿冒和正版的SanDisk驱动器。
...
一次电源中断或非完整写入有时可能导致可修复的小错误。然而，重复的问题则表明需要更换设备。
