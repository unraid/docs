...
:::tip
在进行任何硬件更改后，考虑保存您的[磁盘分配](../../getting-started/set-up-unraid/configure-your-array.mdx#assign-parity-and-data-disks)的屏幕截图。这样可以确保在需要从备份恢复时磁盘能正确放置。
:::
...
这些步骤有助于防止未经授权的更改或暴露关键文件。

---

## 权限

为了增强系统安全性，闪存驱动器上的文件不能再被授予执行权限。此更改可防止恶意或意外代码直接从闪存驱动器运行，降低被利用或系统意外修改的风险。
