...
| 参数                 | 描述                                                             |
| ------------------ | -------------------------------------------------------------- |
| **服务器名称**          | Set in ***Settings → Identification***. Default is `tower`.    |
| **本地 TLD**         | Set in ***Settings → Management Access***. Default is `local`. |
| **使用 SSL/TLS**     | 在 ***设置 → 管理访问***中设置，控制%%SSL\|ssl%%是否启用。                       |
| **HTTP 端口**        | Set in ***Settings → Management Access***. Default is `80`.    |
| **HTTPS 端口**       | Set in ***Settings → Management Access***. Default is `443`.   |
