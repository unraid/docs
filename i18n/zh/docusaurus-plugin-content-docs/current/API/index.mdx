...
Unraid API 提供了一个 GraphQL 接口，用于程序化地与您的 Unraid 服务器进行交互。它支持自动化、监控和集成功能。
...
<div style={{display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '1rem'}}>
  <Card title="CLI命令" icon="terminal" href="./cli">

    所有 CLI 命令的完整参考

  </Card>

  <Card title="使用 API" icon="code" href="./how-to-use-the-api">

    学习如何与 GraphQL API 互动

  </Card>

  <Card title="OIDC 设置" icon="shield" href="./oidc-provider-setup">

    配置 SSO 认证提供商

  </Card>

  <Card title="即将推出的功能" icon="rocket" href="./upcoming-features">
